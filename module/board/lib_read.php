...
function read_message($msg, $simple = false) {
	...
	// </div></li>
	return '<li><div class="'.$class.'"><a href="'.$source.'">'.$source_name.'</a>: '.$content.read_reply($path).'<div class="bar"><span class="time">发表于 '.$time.'</span><span class="link">'.$static_links.'</span></div></div></li>'."\n";
}
