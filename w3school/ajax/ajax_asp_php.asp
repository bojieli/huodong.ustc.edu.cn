...
<li class="pre"><a href="ajax_xmlhttprequest_onreadystatechange.asp">Previous Page</a></li>

<li class="next"><a href="ajax_database.asp">Next Page</a></li>
</ul>
...
<form action="ajax_asp_php.asp" style="margin-top:15px;"> 
