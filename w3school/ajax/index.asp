...
<li class="next"><a href="ajax_intro.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>AJAX 指异步 JavaScript 及 XML（Asynchronous JavaScript And XML）。</strong></p>
<p><strong>AJAX 是一种在 2005 年由 Google 推广开来的编程模式。</strong></p>
<p><strong>AJAX 不是一种新的编程语言，而是一种使用现有标准的新方法。</strong></p>
<p><strong>通过 AJAX，你可以创建更好、更快以及更友好的 WEB 应用程序。</strong></p>
<p><strong>AJAX 基于 JavaScript 和 HTTP 请求（HTTP requests）。</strong></p>

<p><a href="ajax_intro.asp" title="AJAX 简介">现在就开始学习 AJAX</a>！</p>
</div>
