...
<li class="pre"><a href="ajax_asp_php.asp">Previous Page</a></li>

<li class="next"><a href="ajax_xmlfile.asp">Next Page</a></li>
</ul>
...
<form action="ajax_database.asp" style="margin-top:15px;"> 
<label>请选择一位客户：
