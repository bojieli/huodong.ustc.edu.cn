...
<li class="pre"><a href="ado_ref_connection.asp">Previous Page</a></li>

<li class="next"><a href="ado_ref_field.asp">Next Page</a></li>
</ul>
...
<p>ADO Error 对象包含与单个操作（涉及提供者）有关的数据访问错误的详细信息。</p>

<p>ADO 会因每次错误产生一个 Error 对象。每个 Error 对象包含具体错误的详细信息，且 Error 对象被存储在 Errors 集合中。要访问这些错误，就必须引用某个具体的连接。</p>
