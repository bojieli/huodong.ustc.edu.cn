...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <p>有关有效设置的详细信息，请参阅 <a href="prop_conn_connectionstring.asp">ConnectionString</a> 属性。</p>
    </td>
  </tr>
  <tr>
    <td>userID</td>
  ...
  <tr>
    <td>options</td>
    <td>可选。一个 <a href="met_conn_open.asp#connectoptionenum">ConnectOptionEnum</a> 值，确定应在建立连接之后（同步）还是应在建立连接之前（异步）返回本方法。</td>
  </tr>
</table>
</div>
