...
<table class="dataintable"> 
  ...
  <tr>
    ...
    <td>
	包含所发生错误的 Error 对象。
	<p>注释：<a href="ev_conn_transcomplete.asp#eventstatusenum">EventStatusEnum</a> 值必需设置为 adStatusErrorsOccurred ，以创建 Error 对象。</p>
    </td>
  </tr>
  <tr>
    <td>status</td>
    <td>规定事件执行的状态。取 <a href="ev_conn_transcomplete.asp#eventstatusenum">EventStatusEnum</a> 状态值。</td>
  </tr>
  <tr>
    <td>objconn</td>
