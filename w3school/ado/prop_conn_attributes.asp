...
<p><a href="ado_ref_connection.asp" title="ADO Connection 对象">返回 ADO Connection 对象参考手册</a></p>
</div>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>Connection</td>
    <td>Attributes 属性对 Connection 对象拥有读写权限。并且其值可以是一个或多个 <a href="prop_conn_attributes.asp#XactAttributeEnum">XactAttributeEnum</a> 值的和。默认值为零 (0)。</td>
  </tr>
  <tr>
    <td>Parameter</td>
    <td>Attributes 属性对Parameter 对象拥有读写权限。并且其值可以是任意一个或多个 <a href="prop_conn_attributes.asp#ParameterAttributesEnum">ParameterAttributesEnum</a> 值的和。默认值为 adParamSigned。</td>
  </tr>
  <tr>
    <td>Field</td>
    <td>当 Attributes 属性被用于创建 Recordset 时，它拥有读写权限，但是当您打开一个已有的 Recordset 时，它是只读的。Attributes 属性可以是一个或多个 <a href="prop_conn_attributes.asp#FieldAttributeEnum">FieldAttributeEnum</a> 值的和。</td>
  </tr>
  <tr>
    <td>Property</td>
    <td>对于 Property 对象，Attributes 属性是只读的。并且其值可以是任意一个或多个 <a href="prop_conn_attributes.asp#PropertyAttributesEnum">PropertyAttributesEnum</a> 值的和。</td>
  </tr>
</table>
