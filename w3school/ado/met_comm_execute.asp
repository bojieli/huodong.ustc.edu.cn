...
<table class="dataintable"> 
  ...
  <tr>
    <td>options</td>
    <td>可选。指示提供者应如何计算 Command 对象的 CommandText 属性。可以是一个或者多个 <a href="app_commandtypeenum.asp">CommandTypeEnum</a> 或 <a href="app_executeoptionenum.asp">ExecuteOptionEnum</a> 值。默认是 adCmdUnspecified。</td>
  </tr>
</table>
</div>
