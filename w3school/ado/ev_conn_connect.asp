...
<table class="dataintable"> 
  ...
  <tr>
	...
	<p>注释：<a href="ev_conn_connect.asp#eventstatusenum">EventStatusEnum</a> 值必需设置为 adStatusErrorsOccurred ，以创建 Error 对象。</p>
	</td>
  </tr>
  <tr>
    <td>status</td>
    <td>
	<p>一个 <a href="ev_conn_connect.asp#eventstatusenum">EventStatusEnum</a> 值。默认是 adStatusOK。</p>
