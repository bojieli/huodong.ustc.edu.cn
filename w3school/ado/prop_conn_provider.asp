...
<div>
<h2>定义和用法</h2>
<p>Provider 属性可设置或返回包含特定 Connection 对象的提供者名称的字符串值。默认是 MSDASQL (Microsoft OLE DB provider for ODBC)。请参阅 <a href="prop_conn_provider.asp#providercodes">Provider 代码</a>。</p>
<p>在连接关闭时，此属性是可读写的。</p>
