...
<p><a href="ado_ref_command.asp" title="ADO Command 对象">返回 ADO Command 对象参考手册</a></p>
</div>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>type</td>
    <td>可选。<a href="app_datatypeenum.asp">DataTypeEnum</a> 常量之一，指定 Parameter 对象的数据类型。默认是 adEmpty。如果你选择可变长度的数据类型，则需要规定 Size 参数或 Size 属性。如果规定 adDecimal 或者 adNumeric 数据类型，则必须设置 Parameter 对象的NumericScale 和 Precision 属性。</td>
  </tr>
  <tr>
    <td>direction</td>
