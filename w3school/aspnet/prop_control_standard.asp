...
<tr>
<td><a href="prop_control_standard_bindingcontainer.asp" title="ASP.NET BindingContainer 属性">BindingContainer</a></td>
<td>获取包含该控件的数据绑定的控件。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="prop_control_standard_clientid.asp" title="ASP.NET ClientID 属性">ClientID</a></td>
...
<tr>
<td><a href="prop_control_standard_id.asp" title="ASP.NET ID 属性">ID</a></td>
<td>分配给该控件的 id。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="prop_control_standard_namingcontainer.asp" title="ASP.NET NamingContainer 属性">NamingContainer</a></td>
<td>获取对服务器控件的命名容器的引用，此引用创建唯一的命名空间，以区分具有相同 id 属性值的服务器控件。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="prop_control_standard_page.asp" title="ASP.NET Page 属性">Page</a></td>
<td>对包含该控件的页面的引用。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="prop_control_standard_parent.asp" title="ASP.NET Parent 属性">Parent</a></td>
<td>对该控件的父控件的引用。</td>
<td>2.0</td>
</tr>
...
<tr>
<td><a href="prop_control_standard_uniqueid.asp" title="ASP.NET UniqueID 属性">UniqueID</a></td>
<td>获取服务器控件的唯一的、以分层形式限定的标识符。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="prop_control_standard_visible.asp" title="ASP.NET Visible 属性">Visible</a></td>
