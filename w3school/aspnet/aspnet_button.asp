...
<li class="pre"><a href="aspnet_textbox.asp">Previous Page</a></li>

<li class="next"><a href="aspnet_databinding.asp">Next Page</a></li>
</ul>
...
<p>Button 控件的属性列在我们的 <a href="control_button.asp" title="ASP.NET Button 控件">Button 控件参考手册</a>中。</p>
