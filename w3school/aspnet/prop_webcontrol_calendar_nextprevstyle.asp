...
<p><a href="control_calendar.asp" title="ASP.NET Calendar 控件">返回 ASP.NET Calendar 控件参考手册</a></p>
</div>
...
<tr>
<td>style</td>
<td>规定要设置的样式。请参阅 <a href="control_style.asp" title="ASP.NET Style 控件">Style 控件</a>，来查看可能的样式和它们的值。</td>
</tr>
