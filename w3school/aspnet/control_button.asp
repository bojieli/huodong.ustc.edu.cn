...
<div>
<h2>定义和用法</h2>
<p>Button 控件用于显示按钮。按钮可以是提交按钮或命令按钮。默认地，该控件是提交按钮。</p>
<p>提交按钮没有命令名称，在它被点击时它会把网页传回服务器。可以编写事件句柄来控制提交按钮被点击时执行的动作。</p>
<p>命令按钮拥有命令名称，且允许您在页面上创建多个按钮控件。可以编写事件句柄来控制命令按钮被点击时执行的动作。</p>
</div>
...
<tr>
<td><a href="prop_webcontrol_button_causesvalidation.asp" title="ASP.NET CausesValidation 属性">CausesValidation</a></td>
<td>规定当 Button 被点击时是否验证页面。</td>
<td>1.0</td>
</tr>
...
<tr>
<td>CommandName</td>
<td>与 Command 相关的命令。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="prop_webcontrol_button_onclientclick.asp" title="ASP.NET OnClientClick 属性">OnClientClick</a></td>
<td>当按钮被点击时被执行的函数的名称。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="prop_webcontrol_button_postbackurl.asp" title="ASP.NET PostBackUrl 属性">PostBackUrl</a></td>
<td>当 Button 控件被点击时从当前页面传送数据的目标页面 URL。</td>
<td>2.0</td>
</tr>
...
<tr>
<td><a href="prop_webcontrol_button_text.asp" title="ASP.NET Text 属性">Text</a></td>
<td>按钮上的文本。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="prop_webcontrol_button_usesubmitbehavior.asp" title="ASP.NET UseSubmitBehavior 属性">UseSubmitBehavior</a></td>
<td>一个值 ，该值指示 Button 控件使用浏览器的提交机制，还是使用 ASP.NET 的 postback 机制。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="prop_webcontrol_button_validationgroup.asp" title="ASP.NET ValidationGroup 属性">ValidationGroup</a></td>
<td>当 Button 控件回传服务器时，该 Button 所属的哪个控件组引发了验证。</td>
<td>2.0</td>
</tr>
</table>
</div>
...
<h2>实例</h2>
<dl>
<dt><a href="../tiy/s.asp@f=demo_aspnet_button">Button</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个提交 Button 控件。然后我们创建了一个事件句柄，在 Click 事件发生时可更改按钮上的文本。</dd>

<dt><a href="../tiy/s.asp@f=demo_aspnet_button_2">Button 2</a></dt>
<dd>在本例中，我们在 .aspx 文件中声明了一个提交 Button 控件。然后我们创建了一个事件句柄，在 Click 事件发生时可更改按钮的文本和样式。</dd>
</dl>
</div>
