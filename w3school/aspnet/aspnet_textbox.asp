...
<li class="pre"><a href="aspnet_viewstate.asp">Previous Page</a></li>

<li class="next"><a href="aspnet_button.asp">Next Page</a></li>
</ul>
...
<p>TextBox 控件的属性列在我们的 <a href="control_textbox.asp" title="ASP.NET TextBox 控件">TextBox 控件参考手册</a>中。</p>
