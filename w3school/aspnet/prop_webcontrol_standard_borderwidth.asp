...
<p><a href="prop_webcontrol_standard.asp" title="ASP.NET Web 控件标准属性">ASP.NET Web 控件标准属性</a></p>
</div>
...
<h3>语法</h3>
<pre>&lt;asp:<i>webcontrol</i> id=&quot;<i>id</i>&quot; <code>BorderWidth=&quot;<i>length</i>&quot;</code> runat=&quot;server&quot; /&gt;</pre>
...
<table class="dataintable">
	...
	<tr>
		<td>length</td>
		<td>边框的宽度。必须是合法的.NET长度单位。合法的长度单位是 cm, mm, in, pt, pc 或 px。</td>
	</tr>
</table>
</div>
...
<h2>实例</h2>
<dl>
<dt>设置 Table 控件的 BorderWidth</dt>
</dl>
</div>
