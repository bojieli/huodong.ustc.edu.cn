...
<p class="tip"><span>提示：</span>表格的行存储在 <a href="control_table.asp" title="ASP.NET Table 控件">Table 控件</a>中的 Rows 集合中。</p>
</div>
...
<tr>
<td><a href="prop_webcontrol_tablerow_horizontalalign.asp" title="ASP.NET HorizontalAlign 属性">HorizontalAlign</a></td>
<td>表格行中内容的水平对齐方式。</td>
<td>1.0</td>
</tr>

<tr>
<td><a href="prop_webcontrol_tablerow_tablesection.asp" title="ASP.NET TableSection 属性">TableSection</a></td>
<td>Table 控件中 TableRow 对象的位置。</td>
<td>2.0</td>
</tr>

<tr>
<td><a href="prop_webcontrol_tablerow_verticalalign.asp" title="ASP.NET VerticalAlign 属性">VerticalAlign</a></td>
<td>行内容的垂直对齐方式。</td>
<td>1.0</td>
</tr>
</table>
