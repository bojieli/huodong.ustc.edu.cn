...
<h1>ASP.NET 2.0 - 新特性</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="aspnet_dbconnection.asp">Previous Page</a></li>

<li class="next"><a href="aspnet_masterpages.asp">Next Page</a></li>
</ul>
...
<p><a href="aspnet_masterpages.asp">阅读更多有关 master page 的内容</a>。</p>
</div>
...
<ul>
<li>Zone 控件 - 页面上内容一致的区域
<li>Web part 控件 - 每个 zone 的内容区域
</ul>
</div>
...
<li>PasswordRecovery 控件，提供“忘记密码”功能</li>
</ul>
</div>
...
<p>这些控件对移动设备上更优化的图像显示非常重要，比如手持电脑和移动电话。</p>
</div>
