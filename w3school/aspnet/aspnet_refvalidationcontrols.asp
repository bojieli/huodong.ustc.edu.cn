...
<li class="pre"><a href="aspnet_refwebcontrols.asp">Previous Page</a></li>
...
<tr>
<td><a href="control_comparevalidator.asp" title="ASP.NET CompareValidator 控件">CompareValidator</a></td>
<td>把一个输入控件的值与另一个输入控件或一个固定的值进行对比。</td>
</tr>

<tr>
<td><a href="control_customvalidator.asp" title="ASP.NET CustomValidator 控件">CustomValidator</a></td>
<td>允许您编写一个方法，来处理输入值的验证。</td>
</tr>

<tr>
<td><a href="control_rangevalidator.asp" title="ASP.NET RangeValidator 控件">RangeValidator</a></td>
<td>在两个值的范围内检查输入的值。</td>
</tr>

<tr>
<td><a href="control_regularexpvalidator.asp" title="ASP.NET RegularExpressionValidator 控件">RegularExpressionValidator</a></td>
<td>确保输入控件的值匹配指定的模式。</td>
</tr>

<tr>
<td><a href="control_reqfieldvalidator.asp" title="ASP.NET RequiredFieldValidator 控件">RequiredFieldValidator</a></td>
<td>是输入控件成为必需（必填）的字段。</td>
</tr>

<tr>
<td><a href="control_validationsummary.asp" title="ASP.NET ValidationSummary 控件">ValidationSummary</a></td>
