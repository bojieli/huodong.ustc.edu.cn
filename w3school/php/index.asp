...
<li class="next"><a href="php_intro.asp">Next Page</a></li>
</ul>
...
<p><strong>PHP 是免费的，并且使用非常广泛。同时，对于像微软 ASP 这样的竞争者来说，PHP 无疑是另一种高效率的选项。PHP 极其适合网站开发，其代码可以直接嵌入 HTML 代码。</strong></p>
<p><strong>PHP 语法非常类似于 Perl 和 C。PHP 常常搭配 Apache (web 服务器) 一起使用。不过它也支持 ISAPI，并且可以运行于 Windows 的微软 IIS 平台。</strong></p>
<p><a href="php_intro.asp" title="PHP 简介">开始学习 PHP</a> ！</p>
</div>
...
<ul>
<li><a href="php_ref_array.asp" title="PHP Array 函数">Array</a></li>
<li><a href="php_ref_calendar.asp" title="PHP Calendar 函数">Calendar</a></li>
<li><a href="php_ref_date.asp" title="PHP Date / Time 函数">Date</a></li>
<li><a href="php_ref_directory.asp" title="PHP Directory 函数">Directory</a></li>
<li><a href="php_ref_error.asp" title="PHP Error 和 Logging 函数">Error</a></li>
<li><a href="php_ref_filesystem.asp" title="PHP Filesystem 函数">Filesystem</a></li>
<li><a href="php_ref_filter.asp" title="PHP Filter 函数">Filter</a></li>
<li><a href="php_ref_ftp.asp" title="PHP FTP 函数">FTP</a></li>
<li><a href="php_ref_http.asp" title="PHP HTTP 函数">HTTP</a></li>
<li><a href="php_ref_libxml.asp" title="PHP libxml 函数">LibXML</a></li>
<li><a href="php_ref_mail.asp" title="PHP Mail 函数">Mail</a></li>
<li><a href="php_ref_math.asp" title="PHP Math 函数">Math</a></li>
<li><a href="php_ref_mysql.asp" title="PHP MySQL 函数">MySQL</a></li>
<li><a href="php_ref_simplexml.asp" title="PHP SimpleXML 函数">SimpleXML</a></li>
<li><a href="php_ref_string.asp" title="PHP String 函数">String</a></li>
<li><a href="php_ref_xml.asp" title="PHP XML Parser 函数">XML Parser</a></li>
<li><a href="php_ref_zip.asp" title="PHP Zip File 函数">Zip</a></li>
<li><a href="php_ref_misc.asp" title="PHP 杂项函数">杂项函数</a></li>
</ul>
</div>
