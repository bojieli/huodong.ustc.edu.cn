...
<li class="pre"><a href="php_sessions.asp">Previous Page</a></li>

<li class="next"><a href="php_secure_mail.asp">Next Page</a></li>
</ul>
...
<p class="note"><span>注释：</span>PHP 需要一个已安装且正在运行的邮件系统，以便使邮件函数可用。所用的程序通过在 php.ini 文件中的配置设置进行定义。请在我们的 <a href="php_ref_mail.asp" title="PHP Mail 函数">PHP Mail 参考手册</a>阅读更多内容。</p>
