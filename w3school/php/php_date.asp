...
<li class="pre"><a href="php_post.asp">Previous Page</a></li>

<li class="next"><a href="php_includes.asp">Next Page</a></li>
</ul>
...
<p>如需更多有关 PHP 日期函数的信息，请访问 W3School 为您提供的 <a href="php_ref_date.asp" title="PHP Date / Time 函数">PHP Date 参考手册</a>。</p>
</div>
