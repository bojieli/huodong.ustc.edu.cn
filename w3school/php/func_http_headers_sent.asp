...
<p><a href="php_ref_http.asp" title="PHP HTTP 函数">PHP HTTP 函数</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>headers_sent() 函数检查 HTTP 报头是否发送/已发送到何处。</p>

<p>如果报头已发送，则返回 true，否则返回 false。</p>


<h3>语法</h3>
<pre>headers_sent(file,line)</pre>
...
<table class="dataintable"> 
  <tr>
	...
	<tr>
    <td>file,line</td>
    <td>可选。如果设置 file 和 line 参数，headers_sent() 会把输出开始的 PHP 源文件名和行号存入 file 和 line 变量中。</td>
  </tr>
</table>
...
<p class="note"><span>注释：</span>一旦报头块已经发送，就不能使用 header() 添加多个报头行。</p>
<p class="note"><span>注释：</span>可选的 file 和 line 参数是 PHP 4.3 中新加的。</p>
