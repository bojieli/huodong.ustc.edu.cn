...
<p>strptime() 函数解析由 <a href="func_date_strftime.asp" title="PHP strftime() 函数">strftime()</a> 生成的日期／时间。</p>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>date</td>
    <td>要解析的字符串（例如从 <a href="func_date_strftime.asp" title="PHP strftime() 函数">strftime()</a> 返回的）。</td>
  </tr>
  <tr>
    <td>format</td>
    <td>date 所使用的格式（与 <a href="func_date_strftime.asp" title="PHP strftime() 函数">strftime()</a> 中所使用的相同）。 </td>
  </tr>
</table>
