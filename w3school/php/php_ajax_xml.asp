...
<li class="pre"><a href="php_ajax_suggest.asp">Previous Page</a></li>

<li class="next"><a href="php_ajax_database.asp">Next Page</a></li>
</ul>
...
<div id="txtHint" style="margin:0;padding:0;border:0;"><em>在此列出 CD 信息。</em></div>
...
<p>XML 文件是 &quot;<a href="cd_catalog.xml">cd_catalog.xml</a>&quot;。该文件中包含了有关 CD 收藏的数据。</p>
</div>
...
<p>这张页面是用 PHP 编写的，使用 XML DOM 来加载 XML 文档 &quot;<a href="cd_catalog.xml">cd_catalog.xml</a>&quot;。</p>
