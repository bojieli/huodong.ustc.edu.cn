...
<li class="pre"><a href="php_exception.asp">Previous Page</a></li>

<li class="next"><a href="php_mysql_intro.asp">Next Page</a></li>
</ul>
...
<p>如需完整的函数及过滤器列表，请访问 W3School 提供的 PHP Filter 参考手册。您可以看到每个过滤器的可用选项和标志。</p>
</div>
...
<p>假如输入变量类似这样：&quot;http://www.W3#$%S^%$#ool.com.cn/&quot;，则净化后的 $url 变量应该是这样的：</p>
...
<p>在本例中，我们使用  filter_input_array() 函数来过滤三个 GET 变量。接收到的 GET 变量是一个名称、一个年龄以及一个邮件地址：</p>
