...
<p><a href="php_ref_math.asp" title="PHP Math 函数">PHP Math 函数</a></p>
</div>
...
<p class="note"><span>注释：</span>自 PHP 4.2.0 起，不再需要用 <a href="func_math_srand.asp" title="PHP srand() 函数">srand()</a> 或 <a href="func_math_mt_srand.asp" title="PHP mt_srand() 函数">mt_srand()</a> 函数给随机数发生器播种，现在已自动完成。</p>
