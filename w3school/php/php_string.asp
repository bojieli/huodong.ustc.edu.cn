...
<li class="pre"><a href="php_variables.asp">Previous Page</a></li>

<li class="next"><a href="php_operators.asp">Next Page</a></li>
</ul>
...
<p>正如您看到的，在我们的字符串中，字符串 &quot;world&quot; 的位置是 6。返回 6 而不是 7，是由于字符串中的首个位置的 0，而不是 1。</p>
</div>

<div>
<h2>完整的 PHP String 参考手册</h2>

<p>如需完整的字符串函数参考手册，请访问我们的 PHP String 参考手册。</p>
