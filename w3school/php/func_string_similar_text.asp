...
<p class="note"><span>注释：</span><a href="func_string_levenshtein.asp" title="PHP levenshtein() 函数">levenshtein()</a> 函数比 similar_text() 函数更快。不过，similar_text() 函数通过更少的必需修改次数提供更精确的结果。</p>
</div>
