...
<p>该函数是 <a href="func_string_strstr.asp" title="PHP strstr() 函数">strstr()</a> 函数的别名。</p>
...
<p class="note"><span>注释：</span>该函数对大小写敏感。如需进行大小写不敏感的搜索，请使用 <a href="func_string_stristr.asp" title="PHP stristr() 函数">stristr()</a>。</p>
</div>
