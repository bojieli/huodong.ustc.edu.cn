...
<p>文件指针 <i>file</i> 必须是有效的，且必须指向一个通过 <a href="func_filesystem_fopen.asp" title="PHP fopen() 函数">fopen()</a> 或 <a href="func_filesystem_popen.asp" title="PHP popen() 函数">popen()</a> 成功打开的文件。</p>
