...
<li class="pre"><a href="php_mysql_delete.asp">Previous Page</a></li>

<li class="next"><a href="php_xml_parser_expat.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>ODBC 指的是（Application Programming Interface，API），使我们有能力连接到某个数据源（比如一个 MS Access 数据库）。</strong></p>
</div>
...
<h3>例子</h3>
<p>下面的例子创建了到达名为 northwind 的 DSN 的连接，不没有用户名和密码。然后创建并执行一条 SQL 语句：</p>
