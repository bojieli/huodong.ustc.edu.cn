...
<li class="pre"><a href="php_mail.asp">Previous Page</a></li>

<li class="next"><a href="php_error.asp">Next Page</a></li>
</ul>
...
<p>您可以在我们的 <a href="php_filter.asp" title="PHP 过滤器">PHP 过滤器</a>这一节中阅读更多有关过滤器的内容。</p>
</div>
