...
<p>sprintf() 函数把格式化的字符串写写入一个变量中。</p>


<h3>语法</h3>
<pre>sprintf(format,arg1,arg2,arg++)</pre>
...
<p class="note"><span>注释：</span>如果 % 符号多于 arg 参数，则您必须使用占位符。占位符插到 % 符号后面，由数字和 &quot;\$&quot; 组成。请参见例子 3。</p>
...
<a href="func_string_vfprintf.asp" title="PHP vfprintf() 函数">vfprintf()</a>、
<a href="func_string_vprintf.asp" title="PHP vprintf() 函数">vprintf()</a> 以及 
