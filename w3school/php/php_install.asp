...
<li class="pre"><a href="php_intro.asp">Previous Page</a></li>

<li class="next"><a href="php_syntax.asp">Next Page</a></li>
</ul>
...
<p>如果您的服务器支持 PHP - 那么您不需要做任何事情！您不需要编译任何软件，或安装额外的工具 - 只要在您的 web 目录中创建 .php 文件即可 - 然后您的服务器会为您解析这些文件。大多数主机都提供对 PHP 的支持。

<p>不过，如果您的服务器不支持 PHP，那么您必须安装 PHP。下面的链接提供了来自 PHP.net 的优秀教程，您可以从中学习到如何安装 PHP5：
...
<p>从此处下载免费的 MySQL：<a href="http://www.mysql.com/downloads/index.html" title="MySQL AB  MySQL Downloads">http://www.mysql.com/downloads/index.html</a></p>
