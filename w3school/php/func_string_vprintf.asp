...
<p>与 <a href="func_string_printf.asp" title="PHP printf() 函数">printf()</a> 不同，vprintf() 中的 <i>arg</i> 参数位于数组中。数组的元素会被插入主字符串的百分比 (%) 符号处。该函数是逐步执行的。在第一个 % 符号中，插入 arg1，在第二个 % 符号处，插入 arg2，依此类推。</p>
...
<a href="func_string_vsprintf.asp" title="PHP vsprintf() 函数">vsprintf()</a>。
</p>
