...
<table class="dataintable">
  ...
  <tr>
    <td>list</td>
    <td>必需。<a href="func_mysql_list_dbs.asp" title="PHP mysql_list_dbs() 函数">mysql_list_dbs()</a> 调用所返回的结果指针。</td>
  </tr>
  <tr>
    <td>row</td>
...
<p>如果成功，则返回数据库名，失败返回 false。如果返回了 false，用 <a href="func_mysql_error.asp" title="PHP mysql_error() 函数">mysql_error()</a> 来判断错误的种类。</p>
