...
<li class="pre"><a href="php_xml_dom.asp">Previous Page</a></li>

<li class="next"><a href="php_ajax_intro.asp">Next Page</a></li>
</ul>
...
<p>如需更多有关 PHP SimpleXML 的信息，请访问我们的 <a href="php_ref_simplexml.asp" title="PHP SimpleXML 函数">PHP SimpleXML 参考手册</a>。</p>
</div>
