...
<p>接着调用 <a href="func_mysql_fetch_row.asp" title="PHP mysql_fetch_row() 函数">mysql_fetch_row()</a> 将返回那一行。</p>
...
<p class="note"><span>注释：</span>mysql_data_seek() 只能和 <a href="func_mysql_query.asp" title="PHP mysql_query() 函数">mysql_query()</a> 一起使用，而不能用于 <a href="func_mysql_unbuffered_query.asp" title="PHP mysql_unbuffered_query() 函数">mysql_unbuffered_query()</a>。</p>
</div>
