...
<p><a href="php_ref_ftp.asp" title="PHP FTP 函数">PHP FTP 函数</a></p>
</div>
...
<p class="tip"><span>提示：</span>超时时间可以在任何时候通过函数 <a href="func_ftp_set_option.asp" title="PHP ftp_set_option() 函数">ftp_set_option()</a> 及 <a href="func_ftp_get_option.asp" title="PHP ftp_get_option() 函数">ftp_get_option()</a> 来改变和获取。</p>
