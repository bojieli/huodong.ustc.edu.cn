...
<li class="pre"><a href="php_xml_simplexml.asp">Previous Page</a></li>

<li class="next"><a href="php_ajax_xmlhttprequest.asp">Next Page</a></li>
</ul>

</div>

<div>
<h2>AJAX = Asynchronous JavaScript And XML（异步 JavaScript 及 XML）</h2>

<p>AJAX 是 <em>A</em>synchronous <em>J</em>avaScript <em>A</em>nd <em>X</em>ML 的首字母缩写。</p>

<p>AJAX 并不是一种新的编程语言，而仅仅是一种新的技术，它可以创建更好、更快且交互性更强的 web 应用程序。</p>

<p>AJAX 使用 JavaScript 在 web 浏览器与 web 服务器之间来发送和接收数据。</p>

<p>通过在幕后与 web 服务器交换数据，而不是每当用户作出改变时重载整个 web 页面，AJAX 技术可以使网页更迅速地响应。</p>
</div>
...
<p>在 AJAX 中使用的开放标准被良好地定义，并得到所有主要浏览器的支持。AJAX 应用程序独立于浏览器和平台。（可以说，它是一种跨平台跨浏览器的技术）。</p>
</div>

<div>
<h2>AJAX 事关更好的 Internet 应用程序</h2>

<p>与桌面应用程序相比，Web 应用程序有很多优势：</p>
...
<p>但是， 应用程序不总是象传统应用程序那样强大和友好。</p>

<p>通过 AJAX，可以使 Internet 应用程序更加强大（更轻巧、更快速，且更易使用）。</p>
</div>

<div>
<h2>今天您就可以开始使用 AJAX</h2>

<p>没有什么新知识需要学习。</p>

<p>AJAX 基于开放的标准。而这些标准已被大多数开发者使用多年。</p>

<p>大多数 web 应用程序可通过使用 AJAX 技术进行重写，来替代传统的 HTML 表单。</p>
</div>

<div>
<h2>AJAX 使用 XML 和 HTTP 请求</h2>

<p>传统的 web 应用程序会把数据提交到 web 服务器（使用 HTML 表单）。在 web 服务器把数据处理完毕之后，会向用户返回一张完整的新网页。</p>

<p>由于每当用户提交输入，服务器就会返回新网页，传统的 web 应用程序往往运行缓慢，且越来越不友好。</p>

<p>通过 AJAX，web 应用程序无需重载网页，就可以发送并取回数据。完成这项工作，需要通过向服务器发送 HTTP 请求（在幕后），并通过当服务器返回数据时使用 JavaScript 仅仅修改网页的某部分。</p>

<p>一般使用 XML 作为接收服务器数据的格式，尽管可以使用任何格式，包括纯文本。</p>

<p>您将在本教程接下来的章节学习到如何完成这些工作。</p>
</div>
...
<p>AJAX 是一种在浏览器运行的技术。它使用浏览器与 web 服务器之间的异步数据传输，使网页从服务器请求少量的信息，而不是整张页面。</p>

<p>AJAX 是一种独立于 web 服务器软件的 web 浏览器技术。</p>

<p>但是，在本教程中，我们将集中在运行在 PHP 服务器上的实际案例，而不是 AJAX 的<em>工作原理</em>。</p>

<p>如需阅读更多有关 AJAX 如何工作的知识，请访问我们的 <a href="../ajax/index.asp" title="AJAX 教程">AJAX 教程</a>。</p>
</div>
