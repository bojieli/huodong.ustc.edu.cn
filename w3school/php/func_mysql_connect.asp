...
<p class="note"><span>注释：</span>脚本一结束，到服务器的连接就被关闭，除非之前已经明确调用 <a href="func_mysql_close.asp" title="PHP mysql_close() 函数">mysql_close()</a> 关闭了。</p>

<p class="tip"><span>提示：</span>要创建一个持久连接，请使用 <a href="func_mysql_pconnect.asp" title="PHP mysql_pconnect() 函数">mysql_pconnect()</a> 函数。</p>
</div>
