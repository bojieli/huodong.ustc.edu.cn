...
<p class="note"><span>注释：</span>php.ini 中的 magic_quotes_gpc 设置影响该函数的输出。如果已启用，那么在 parse_str() 解析之前，变量会被 <a href="func_string_addslashes.asp" title="PHP addslashes() 函数">addslashes()</a> 转换。</p>
</div>
