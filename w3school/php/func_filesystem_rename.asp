...
<h3>语法</h3>
<pre>rename(oldname,newname,context)</pre>
...
<p class="note"><span>注释：</span>用于 oldname 中的封装协议<em>必须</em>和用于 newname 中的相匹配。</p>

<p class="note"><span>注释：</span>对 context 的支持是 PHP 5.0.0 添加的。</p>
