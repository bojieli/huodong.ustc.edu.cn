...
<p>该函数将使用 <i>TZ</i> 环境变量（如果有的话）来计算时间戳。自 PHP 5.1.0 起有更容易的方法来定义时区用于所有的日期／时间函数。此过程在 <a href="func_date_default_timezone_get.asp" title="PHP date_default_timezone_get() 函数">date_default_timezone_get()</a> 函数页面中有说明。</p>
