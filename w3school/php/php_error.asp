...
<li class="pre"><a href="php_secure_mail.asp">Previous Page</a></li>

<li class="next"><a href="php_exception.asp">Next Page</a></li>
</ul>
...
<p>现在，我们已经学习了如何创建自己的 error，以及如何处罚它们，现在我们研究一下错误记录。</p>
</div>
