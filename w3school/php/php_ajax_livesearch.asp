...
<li class="pre"><a href="php_ajax_responsexml.asp">Previous Page</a></li>

<li class="next"><a href="php_ajax_rss_reader.asp">Next Page</a></li>
</ul>
...
<p>在本例中，结果在一个 XML 文档  (<a href="links.xml">links.xml</a>) 中进行查找。为了让这个例子小而简单，我们只提供 8 个结果。</p>
</div>
...
<p>GetXmlHttpObject 与 <a href="php_ajax_suggest.asp" title="PHP 和 AJAX 请求">PHP 和 AJAX 请求</a> 中的例子相同。</p>
