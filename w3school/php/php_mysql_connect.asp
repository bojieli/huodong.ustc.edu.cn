...
<li class="pre"><a href="php_mysql_intro.asp">Previous Page</a></li>

<li class="next"><a href="php_mysql_create.asp">Next Page</a></li>
</ul>
...
<p class="note"><span>注释：</span>虽然还存在其他的参数，但上面列出了最重要的参数。请访问 W3School 提供的 <a href="php_ref_mysql.asp" title="PHP MySQL 函数">PHP MySQL 参考手册</a>，获得更多的细节信息。</p>
