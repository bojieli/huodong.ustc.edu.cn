...
<p class="note"><span>注释：</span>setrawcookie() 与 <a href="func_http_setcookie.asp" title="PHP setcookie() 函数">setcookie()</a> 几乎完全相同，不同的是不会在发往客户机时，对 cookie 值进行自动 URL 编码。</p>
