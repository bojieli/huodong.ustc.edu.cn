...
<p>array_udiff() 函数与 <a href="func_array_diff.asp" title="PHP array_diff() 函数">array_diff() 函数</a> 的行为不同，后者用内部函数进行比较。</p>
...
<h3>语法</h3>
<pre>array_udiff(array1,array2,array3...,function)</pre>
