...
<p class="tip"><span>提示：</span>该函数不会移动内部指针。要做到这一点，请使用 <a href="func_array_next.asp" title="PHP next() 函数">next()</a> 和 <a href="func_array_prev.asp" title="PHP prev() 函数">prev()</a> 函数。</p>
</div>
