...
<li class="pre"><a href="php_ajax_xmlhttprequest.asp">Previous Page</a></li>

<li class="next"><a href="php_ajax_xml.asp">Next Page</a></li>
</ul>
...
<div>
<h2>在下面的文本框中输入名字：</h2>
<form action="php_ajax_suggest.asp"> 
