...
<p>如果 <i>parser</i> 参数没有指向一个合法的解析器，该函数将返回 false。否则将返回指定解析器所在行（由函数 <a href="func_xml_get_current_line_number.asp" title="PHP xml_get_current_line_number() 函数">xml_get_current_line_number()</a> 给定）的当前列号。</p>
