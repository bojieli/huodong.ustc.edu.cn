...
<p>行是由这些函数返回的：<a href="func_mysql_fetch_array.asp" title="PHP mysql_fetch_array() 函数">mysql_fetch_array()</a>、<a href="func_mysql_fetch_assoc.asp" title="PHP mysql_fetch_assoc() 函数">mysql_fetch_assoc()</a>、<a href="func_mysql_fetch_object.asp" title="PHP mysql_fetch_object() 函数">mysql_fetch_object()</a> 或 <a href="func_mysql_fetch_row.asp" title="PHP mysql_fetch_row() 函数">mysql_fetch_row()</a>。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td>data</td>
    <td>必需。要使用的数据指针。该数据指针是从 <a href="func_mysql_query.asp" title="PHP mysql_query() 函数">mysql_query()</a> 返回的结果。</td>
  </tr>
</table>
