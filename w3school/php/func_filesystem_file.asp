...
<p>与 <a href="func_filesystem_file_get_contents.asp" title="PHP file_get_contents() 函数">file_get_contents()</a> 类似，不同的是 file() 将文件作为一个数组返回。数组中的每个单元都是文件中相应的一行，包括换行符在内。</p>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>从 PHP 4.3.0 开始，可以用 <a href="func_filesystem_file_get_contents.asp" title="PHP file_get_contents() 函数">file_get_contents()</a> 来将文件读入到一个字符串并返回。 </p>
