...
<p>如果 <i>function</i> 函数需要的参数比给出的多，则每次 array_walk() 调用 <i>function</i> 时都会产生一个 E_WARNING 级的错误。这些警告可以通过在 array_walk() 调用前加上 PHP 的错误操作符 @ 来抑制，或者用 <a href="func_error_reporting.asp" title="PHP error_reporting() 函数">error_reporting()</a>。</p>
