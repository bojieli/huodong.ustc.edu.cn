...
<p>返回一个和 <a href="func_filesystem_fopen.asp" title="PHP fopen() 函数">fopen()</a> 所返回的相同的文件指针，只不过它是单向的（只能用于读或写）并且必须用 <a href="func_filesystem_pclose.asp" title="PHP pclose() 函数">pclose()</a> 来关闭。此指针可以用于 <a href="func_filesystem_fgets.asp" title="PHP fgets() 函数">fgets()</a>，<a href="func_filesystem_fgetss.asp" title="PHP fgetss() 函数">fgetss()</a> 和 <a href="func_filesystem_fwrite.asp" title="PHP fwrite() 函数">fwrite()</a>。</p>
