...
<p>get_html_translation_table() 函数返回被 <a href="func_string_htmlentities.asp" title="PHP htmlentities() 函数">htmlentities()</a> 和 <a href="func_string_htmlspecialchars.asp" title="PHP htmlspecialchars() 函数">htmlspecialchars()</a> 函数使用的翻译表。</p>
