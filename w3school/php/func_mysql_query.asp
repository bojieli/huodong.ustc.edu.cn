...
<p class="note"><span>注释：</span>该函数自动对记录集进行读取和缓存。如需运行非缓存查询，请使用 <a href="func_mysql_unbuffered_query.asp" title="PHP mysql_unbuffered_query() 函数">mysql_unbuffered_query()</a>。</p>
</div>
