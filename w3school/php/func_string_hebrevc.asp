...
<p class="tip"><span>提示：</span><a href="func_string_hebrev.asp" title="PHP hebrev() 函数">hebrev()</a> 和 hebrevc() 可以把希伯来逻辑文本转换为希伯来可见文本。希伯来可见文本不需要特殊的右至左字符支持，这使它对于在 web 上显示希伯来文本很有用处。</p>
</div>
