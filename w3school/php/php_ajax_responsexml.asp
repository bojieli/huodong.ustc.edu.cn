...
<li class="pre"><a href="php_ajax_database.asp">Previous Page</a></li>

<li class="next"><a href="php_ajax_livesearch.asp">Next Page</a></li>
</ul>
...
<form action="php_ajax_responsexml.asp"> 
Select a User:
<select>
...
<p>showUser() 与 GetXmlHttpObject 函数与 <a href="php_ajax_database.asp" title="PHP 和 AJAX MySQL 数据库实例">PHP 和 AJAX MySQL 数据库实例</a> 这一节中的例子是相同的。您可以参阅其中的相关解释。</p>
