...
<p class="tip"><span>提示：</span>要释放 XML 解析器，请使用 <a href="func_xml_parser_free.asp" title="PHP xml_parser_free() 函数">xml_parser_free()</a> 函数。</p>

<p class="tip"><span>提示：</span>要创建带有命名空间支持的 XML 解析器，请使用 <a href="func_xml_parser_create_ns.asp" title="PHP xml_parser_create_ns() 函数">xml_parser_create_ns()</a> 函数。</p>
</div>
