...
<li class="pre"><a href="php_ajax_xml.asp">Previous Page</a></li>

<li class="next"><a href="php_ajax_responsexml.asp">Next Page</a></li>
</ul>
...
<form action="php_ajax_database.asp" style="margin-top:15px;"> 
Select a User:
<select>
