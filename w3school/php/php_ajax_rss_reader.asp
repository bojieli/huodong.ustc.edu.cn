...
<li class="pre"><a href="php_ajax_livesearch.asp">Previous Page</a></li>

<li class="next"><a href="php_ajax_poll.asp">Next Page</a></li>
</ul>
...
<form action="php_ajax_rss_reader.asp"> 
Select an RSS-Feed:
<select>
