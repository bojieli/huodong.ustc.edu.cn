...
<p><a href="php_ref_zip.asp" title="PHP Zip File 函数">PHP Zip File 函数</a></p>
</div>
...
<p class="tip"><span>提示：</span>新打开的 zip 文件资源之后可被 <a href="func_zip_read.asp" title="PHP zip_read() 函数">zip_read()</a> 和 <a href="func_zip_close.asp" title="PHP zip_close() 函数">zip_close()</a> 函数使用。</p>
</div>
