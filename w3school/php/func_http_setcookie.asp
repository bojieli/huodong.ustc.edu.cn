...
<p class="note"><span>注释：</span>在发送 cookie 时，cookie 的值会自动进行 URL 编码。接收时会进行 URL 解码。如果你不需要这样，可以使用 <a href="func_http_setrawcookie.asp" title="PHP setrawcookie() 函数">setrawcookie()</a> 代替。</p>
