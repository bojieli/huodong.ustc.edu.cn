...
<table class="dataintable">
  ...
  <tr>
    ...
    <td>必需。MySQL 的连接标识符。如果没有指定，默认使用最后被 <a href="func_mysql_connect.asp" title="PHP mysql_connect() 函数">mysql_connect()</a> 打开的连接。如果没有找到该连接，函数会尝试调用 <a href="func_mysql_connect.asp" title="PHP mysql_connect() 函数">mysql_connect()</a> 建立连接并使用它。如果发生意外，没有找到连接或无法建立连接，系统发出 E_WARNING 级别的警告信息。</td>
  </tr>
</table>
