...
<p><a href="php_ref_string.asp" title="PHP String 函数">PHP String 函数</a></p>
</div>
...
<p>与 <a href="func_string_sprintf.asp" title="PHP sprintf() 函数">sprintf()</a> 不同，vsprintf() 中的 <i>arg</i> 参数位于数组中。数组的元素会被插入主字符串的百分比 (%) 符号处。该函数是逐步执行的。在第一个 % 符号中，插入 arg1，在第二个 % 符号处，插入 arg2，依此类推。</p>
...
相关函数：
<a href="func_string_fprintf.asp" title="PHP fprintf() 函数">fprintf()</a>、
<a href="func_string_printf.asp" title="PHP printf() 函数">printf()</a>、
<a href="func_string_sprintf.asp" title="PHP sprintf() 函数">sprintf()</a>、
<a href="func_string_vfprintf.asp" title="PHP vfprintf() 函数">vfprintf()</a> 以及 
<a href="func_string_vprintf.asp" title="PHP vprintf() 函数">vprintf()</a>。
</p>
