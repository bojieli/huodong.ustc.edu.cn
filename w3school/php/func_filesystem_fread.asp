...
<p class="tip"><span>提示：</span>如果只是想将一个文件的内容读入到一个字符串中，请使用 <a href="func_filesystem_file_get_contents.asp" title="PHP file_get_contents() 函数">file_get_contents()</a>，它的性能比 fread() 好得多。</p>
</div>
