...
<li class="pre"><a href="php_mysql_create.asp">Previous Page</a></li>

<li class="next"><a href="php_mysql_select.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>INSERT INTO 语句用于向数据库表中插入新纪录。</strong></p>
</div>

<div>
<h2>向数据库表插入数据</h2>

<p>INSERT INTO 语句用于向数据库表添加新纪录。</p>
...
<h3>例子</h3>
<p>在前面的章节，我们创建了一个名为 &quot;Persons&quot; 的表，有三个列：&quot;Firstname&quot;, &quot;Lastname&quot; 以及 &quot;Age&quot;。我们将在本例中使用同样的表。下面的例子向 &quot;Persons&quot; 表添加了两个新纪录：</p>
...
<p>现在，我们创建一个 HTML 表单，这个表单可把新纪录插入 &quot;Persons&quot; 表。</p>
