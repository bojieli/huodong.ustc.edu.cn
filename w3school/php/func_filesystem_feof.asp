...
<p><i>file</i> 参数是一个文件指针。这个文件指针必须有效，并且必须指向一个由 <a href="func_filesystem_fopen.asp" title="PHP fopen() 函数">fopen()</a> 或 fsockopen() 成功打开（但还没有被 <a href="func_filesystem_fclose.asp" title="PHP fclose() 函数">fclose()</a> 关闭）的文件。</p>
</div>
