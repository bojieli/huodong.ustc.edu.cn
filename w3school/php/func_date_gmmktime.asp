...
<p><a href="php_ref_date.asp" title="PHP Date / Time 函数">PHP Date / Time 函数</a></p>
</div>
...
<p>与 <a href="func_date_mktime.asp" title="PHP mktime() 函数">mktime()</a> 类似，不同的是返回值是格林威治标准时的时间戳。</p>

<p>参数总是表示 GMT 日期，因此 <i>is_dst</i> 对结果没有影响。</p>

<p>与 <a href="func_date_mktime.asp" title="PHP mktime() 函数">mktime()</a> 一样，参数可以从右到左依次空着，空着的参数会被设为相应的当前 GMT 值。</p>
...
<div>
<h2>提示和注释</h2>
<p class="note"><span>注释：</span>gmmktime() 内部使用了 <a href="func_date_mktime.asp" title="PHP mktime() 函数">mktime()</a>，因此只有转换成本地时间也合法的时间才能用在其中。</p>
</div>
