...
<li class="next"><a href="asp_intro.asp">Next Page</a></li>
</ul>
...
<p><a href="asp_intro.asp" title="ASP 简介">开始学习 ASP</a> ！</p>
</div>

<div>
<h2>ASP 参考手册</h2>
<p>在 W3School，我们为您提供完整的 ASP 参考手册，其中包括内建对象和组件，以及它们的属性和方法。</p>
<p><a href="asp_ref.asp">ASP 参考手册</a></p>
</div>

<div>
<h2>ASP 实例</h2>
<p>通过实例来学习！因为 ASP 脚本只能在服务器端执行，所以你无法在浏览器中查看 ASP 代码，你能看到的仅仅是由 ASP 输出的纯粹的 HTML 代码。在 W3School，每个实例均可显示出以往被隐藏的 ASP 代码。这样，您就可以更容易地理解它们的工作原理。</p>
...
<p><a href="asp_quiz.asp" title="ASP 测验">开始 ASP 测验</a>！</p>
</div>
