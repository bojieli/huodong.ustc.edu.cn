...
<h3>语法：</h3>
<pre>response.Expires[=number]</pre>
...
<h3>例子 1</h3>
<p>下面的代码指示页面不会被缓存：</p>
<pre>&lt;%response.Expires=-1%&gt;</pre>

<h3>例子 2</h3>
<p>下面的代码指示，页面会在 1660 分钟后失效：</p>
<pre>&lt;%response.Expires=1660%&gt;</pre>
</div>
