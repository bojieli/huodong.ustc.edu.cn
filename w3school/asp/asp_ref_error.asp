...
<li class="pre"><a href="asp_ref_server.asp">Previous Page</a></li>

<li class="next"><a href="asp_ref_filesystem.asp">Next Page</a></li>
</ul>
...
<p class="note"><span>注释：</span>下面的属性只能 <a href="met_getlasterror.asp" title="ASP GetLastError() 方法 (ASP 3.0)">Server.GetLastError()</a> 方法来访问。</p>
