...
<p><a href="xsl_functions.asp" title="XSLT 函数参考手册">XSLT 函数参考手册</a></p>
</div>
...
<p><a href="cdcatalog.xml">查看 XSL 文件</a>，<a href="cdcatalog_generateid.xsl">查看 XSL 文件</a>，<a href="cdcatalog_generateid.xml">查看结果</a>。</p>
</div>
