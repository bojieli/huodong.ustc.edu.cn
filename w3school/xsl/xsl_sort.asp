...
<li class="pre"><a href="xsl_for_each.asp">Previous Page</a></li>

<li class="next"><a href="xsl_if.asp">Next Page</a></li>
</ul>
...
<p><a href="cdcatalog.xml">查看此 XML 文件</a>，<a href="cdcatalog_sort.xsl">查看此 XSL 文件</a>，<a href="cdcatalog_sort.xml">并查看结果</a>。</p>
</div>
