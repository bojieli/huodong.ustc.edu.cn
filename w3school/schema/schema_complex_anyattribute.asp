...
<title>XSD &lt;anyAttribute&gt; 元素</title>
</head>
...
<h2>Schema 教程</h2>
<ul>
<li><a href="index.asp" title="XSD首页">XSD 首页</a></li>
<li><a href="schema_intro.asp" title="XSD简介">XSD 简介</a></li>
<li><a href="schema_why.asp" title="为什么要使用XML Schemas？">XSD 为何使用</a></li>
<li><a href="schema_howto.asp" title="如何使用XSD？">XSD 如何使用</a></li>
...
<li><a href="schema_complex_anyattribute.asp" title="">XSD &lt;anyAttribute&gt;</a></li>
...
<li><a href="schema_dtypes_date.asp" title="XSD 日期及时间数据类型（Date and Time Data Types）">XSD 日期</a></li>
<li><a href="schema_dtypes_numeric.asp" title="XSD 数值数据类型（Numeric Data Types）">XSD 数值</a></li>
<li><a href="schema_dtypes_misc.asp" title="XSD 杂项数据类型（Miscellaneous Data Types）">XSD 杂项</a></li>
<li><a href="schema_summary.asp" title="您已经学习了XML Schema，下一步学习什么呢？">XSD 总结</a></li>
</ul>
...
<h1>XSD &lt;anyAttribute&gt; 元素</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="schema_complex_any.asp">Previous Page</a></li>

<li class="next"><a href="schema_complex_subst.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>&lt;anyAttribute&gt; 元素使我们有能力通过未被 schema 规定的属性来扩展 XML 文档！</strong></p>
</div>

<div>
<h2>&lt;anyAttribute&gt; 元素</h2>

<p>&lt;anyAttribute&gt; 元素使我们有能力通过未被 schema 规定的属性来扩展 XML 文档！</p>

<p>下面的例子是来自名为 &quot;family.xsd&quot; 的 XML schema 的一个片段。它为我们展示了针对 &quot;person&quot; 元素的一个声明。通过使用 &lt;anyAttribute&gt; 元素，我们就可以向 &quot;person&quot; 元素添加任意数量的属性：</p>
...
<p>现在，我们希望通过 &quot;gender&quot; 属性来扩展 &quot;person&quot; 元素。在这种情况下我们就可以这样做，即使这个 schema 的作者从未声明过任何 &quot;gender&quot; 属性。</p>

<p>请看这个 schema 文件，名为 &quot;attribute.xsd&quot;：</p>
