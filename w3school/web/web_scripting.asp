...
<li class="pre"><a href="web_xml.asp">Previous Page</a></li>

<li class="next"><a href="web_sql.asp">Next Page</a></li>
</ul>
...
<p>客户端脚本是对浏览器行为的编程。（请参阅 <a href="web_javascript.asp">JavaScript 初级教程</a>）。</p>
</div>
