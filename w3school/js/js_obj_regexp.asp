...
<li class="pre"><a href="js_obj_math.asp">Previous Page</a></li>

<li class="next"><a href="js_obj_htmldom.asp">Next Page</a></li>
</ul>
...
<p>如需关于如何修改搜索模式的完整信息，请访问我们的 <a href="jsref_obj_regexp.asp" title="JavaScript RegExp 对象参考手册">RegExp 对象参考手册</a>。</p>
...
<p>如需可与 RegExp 对象一同使用所有属性和方法的完整信息，请访问我们的 <a href="jsref_obj_regexp.asp" title="JavaScript RegExp 对象参考手册">RegExp 对象参考手册</a>。</p>
