...
<title>JavaScript For...In 声明</title>
</head>
...
<div id="maincontent">
<h1>JavaScript For...In 声明</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="js_break.asp">Previous Page</a></li>

<li class="next"><a href="js_events.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>For...In 声明用于遍历数组或者对象的属性（对数组或者对象的属性进行循环操作）。</strong></p>
</div>

<div class="example">
<h2>实例</h2>
<dl>
<dt><a href="../tiy/t.asp@f=jseg_array_for_in">For...In 声明</a></dt>
<dd>如何使用 For...In 声明来遍历数组内的元素。</dd>
</dl>
</div>

<div>
<h2>JavaScript For...In 声明</h2>
<p>For...In 声明用于对数组或者对象的属性进行循环操作。</p>
<p>for ... in 循环中的代码每执行一次，就会对数组的元素或者对象的属性进行一次操作。</p>
<h3>语法：</h3>
<pre><code>for</code> (变量 <code>in</code> 对象)
{
    在此执行代码
}</pre>
<p>“变量”用来指定变量，指定的变量可以是数组元素，也可以是对象的属性。</p>
<h3>实例：</h3>
...
<p>如需更多有关 <em>JavaScript for-in 语句</em>的知识，请阅读 JavaScript 高级教程中的相关内容：</p>
