...
<li class="pre"><a href="js_obj_intro.asp">Previous Page</a></li>

<li class="next"><a href="js_obj_date.asp">Next Page</a></li>
</ul>
...
<p>请查看我们的 <a href="jsref_obj_string.asp">JavaScript String 对象参考手册</a>，其中提供了可以与字符串对象一同使用的所有的属性和方法。</p>
...
<p>JavaScript 高级教程：<a href="pro_js_typeconversion.asp" title="ECMAScript 类型转换">ECMAScript 类型转换</a></p>
