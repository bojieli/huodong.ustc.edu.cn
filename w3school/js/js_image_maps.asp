...
<h1>JavaScript 图像地图</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="js_animation.asp">Previous Page</a></li>

<li class="next"><a href="js_timing.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>图像地图指的是带有可点击区域的图像。</strong></p>
</div>

<div class="example">
<h2>实例</h2>
<dl>
<dt><a href="../tiy/t.asp@f=jseg_imagemap_simple">简单的 HTML 图像映射</a></dt>
<dt>本例演示一幅没有添加 JavaScript 的图像映射。</dt>

<dt><a href="../tiy/t.asp@f=jseg_imagemap">添加了 JavaScript 的图像映射</a></dt>
<dt>本例演示一幅添加了 JavaScript 的图像映射，当鼠标浮动于某个热点上时，会调用 JavaScript 函数来显示热点所对应的星球的简介。</dt>
</dl>
</div>

<div>
<h2>JavaScript 图像地图</h2>
<p>我们已经从 HTML 教程中了解到，图像地图是带有可点击区域的图像。通常情况下，每个区域是一个相关的超级链接。单击某个区域，就回到达相关的链接。</p>

<h3>实例</h3>
<p>下面的例子演示如何创建带有可点击区域的 html 图像地图：</p>
<pre>&lt;img src =&quot;planets.gif&quot; width =&quot;145&quot; height =&quot;126&quot; 
...
<p>我们可向图像地图内部的 &lt;area&gt; 标签添加（能调用JavaScript的）事件。&lt;area&gt; 标签支持以下事件：onClick、onDblClick、onMouseDown、onMouseUp、onMouseOver、onMouseMove、onMouseOut、onKeyPress、onKeyDown、onKeyUp、onFocus和onBlur。</p>

<p>这是添加了 JavaScript 的上面的例子：</p>
<pre>&lt;html&gt;
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
...
<code>onMouseOver</code>=&quot;<code>writeText</code>('The Sun and the gas giant
planets like Jupiter are by far the largest objects
in our Solar System.')&quot;
href =&quot;sun.htm&quot; target =&quot;_blank&quot; alt=&quot;Sun&quot; /&gt;

&lt;area shape =&quot;circle&quot; coords =&quot;90,58,3&quot;
<code>onMouseOver</code>=&quot;<code>writeText</code>('The planet Mercury is very
difficult to study from the Earth because it is
always so close to the Sun.')&quot;
href =&quot;mercur.htm&quot; target =&quot;_blank&quot; alt=&quot;Mercury&quot; /&gt;

&lt;area shape =&quot;circle&quot; coords =&quot;124,58,8&quot;
<code>onMouseOver</code>=&quot;<code>writeText</code>('Until the 1960s, Venus was
