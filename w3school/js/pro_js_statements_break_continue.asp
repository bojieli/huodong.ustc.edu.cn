...
<li class="pre"><a href="pro_js_statements_labeled.asp">Previous Page</a></li>

<li class="next"><a href="pro_js_statements_with.asp">Next Page</a></li>
</ul>
...
<p class="tip"><span>提示：</span>想了解什么是有标签语句，请阅读 <a href="pro_js_statements_labeled.asp" title="ECMAScript 标签语句">ECMAScript 标签语句</a> 这一节。</p>
</div>
