...
<h1>JavaScript 指导方针</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="js_special_characters.asp">Previous Page</a></li>

<li class="next"><a href="js_obj_intro.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>本节的内容是：在使用 JavaScript 进行编码的过程中，其他一些需要了解的重要事项。</strong></p>
</div>

<div>
<h2>JavaScript 对大小写敏感</h2>
<p>名为 &quot;myfunction&quot; 的函数和名为 &quot;myFunction&quot; 的函数是两个不同的函数，同样，变量 &quot;myVar&quot; 和变量 &quot;myvar&quot; 也是不同的。</p>
<p>JavaScript 对大小写敏感 - 所以当您创建或使用变量、对象及函数时，请注意字符的大小写。</p>
</div>

<div>
<h2>空格</h2>
<p>JavaScript 会忽略多余的空格。所以您可以在代码中添加适当的空格，使得代码的可读性更强。下面的两行是等效的：</p>
<pre>name=&quot;Hege&quot;
name = &quot;Hege&quot;</pre>
</div>
...
<div>
<h2>换行</h2>
<p>您可以<em>在文本字符串内部</em>使用反斜杠对代码进行折行。下面的例子是正确的：</p>
