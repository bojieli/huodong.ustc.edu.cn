...
<li class="pre"><a href="pro_js_reservedwords.asp">Previous Page</a></li>

<li class="next"><a href="pro_js_primitivetypes.asp">Next Page</a></li>
</ul>
...
<p>如前所述，ECMAScript 有 5 种原始类型（primitive type），即 Undefined、Null、Boolean、Number 和 String。EMCA-262 把术语<em>类型（type）</em>定义为值的一个集合，每种原始类型定义了它包含的值的范围及其字面量表示形式。</p>
