...
<li class="pre"><a href="js_obj_date.asp">Previous Page</a></li>

<li class="next"><a href="js_obj_boolean.asp">Next Page</a></li>
</ul>
...
<p>我们提供 <a href="jsref_obj_array.asp">JavaScript Array 对象参考手册</a>，其中包括所有可用于数组对象的属性和方法。</p>
