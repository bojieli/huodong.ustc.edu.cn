...
<li class="next"><a href="js_howto.asp">Next Page</a></li>
</ul>
...
<div>
<h2>真实的名称是 ECMAScript</h2>

<p>JavaScript 的正式名称是 &quot;<a href="http://www.ecma-international.org/publications/index.html" title="Ecma formal publications">ECMAScript</a>&quot;。这个标准由 ECMA 组织发展和维护。</p>

<p>ECMA-262 是正式的 JavaScript 标准。这个标准基于 JavaScript (Netscape) 和 JScript (Microsoft)。</p>

<p>Netscape (Navigator 2.0) 的 Brendan Eich 发明了这门语言，从 1996 年开始，已经出现在所有的 Netscape 和 Microsoft 浏览器中。</p>

<p>ECMA-262 的开发始于 1996 年，在 1997 年 7 月，ECMA 会员大会采纳了它的首个版本。</p>

<p>在 1998 年，该标准成为了国际 ISO 标准 (ISO/IEC 16262)。</p>
...
<p>JavaScript 高级教程：
<a href="pro_js_history.asp" title="JavaScript 的历史">JavaScript 历史</a>
、
<a href="pro_js_implement.asp" title="JavaScript 实现">JavaScript 实现</a>
</p>
</div>
</div>
