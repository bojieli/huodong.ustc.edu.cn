...
<li class="pre"><a href="js_quiz.asp">Previous Page</a></li>
...
<ul class="small">
<li><a href="jsref_obj_array.asp">Array</a></li>
<li><a href="jsref_obj_boolean.asp">Boolean</a></li>
<li><a href="jsref_obj_date.asp">Date</a></li>
<li><a href="jsref_obj_math.asp">Math</a></li>
<li><a href="jsref_obj_number.asp">Number</a></li>
<li><a href="jsref_obj_string.asp">String</a></li>
<li><a href="jsref_obj_regexp.asp">RegExp</a></li>
<li><a href="jsref_obj_global.asp">Global</a></li>
</ul>
</div>
...
<p>本参考手册描述每个对象的属性和方法，并提供实例。</p>
<ul class="small">
<li><a href="../htmldom/dom_obj_window.asp" title="HTML DOM Window 对象">Window</a></li>
<li><a href="../htmldom/dom_obj_navigator.asp" title="HTML DOM Navigator 对象">Navigator</a></li>
<li><a href="../htmldom/dom_obj_screen.asp" title="HTML DOM Screen 对象">Screen</a></li>
<li><a href="../htmldom/dom_obj_history.asp" title="HTML DOM History 对象">History</a></li>
<li><a href="../htmldom/dom_obj_location.asp" title="HTML DOM Location 对象">Location</a></li>
</ul>
</div>
...
<p>本参考手册描述每个对象的属性和方法，并提供实例。</p>
<ul class="small">
<li><a href="../htmldom/dom_obj_document.asp" title="HTML DOM Document 对象">Document</a></li>
<li><a href="../htmldom/dom_obj_anchor.asp" title="HTML DOM Anchor 对象">Anchor</a></li>
<li><a href="../htmldom/dom_obj_area.asp" title="HTML DOM Area 对象">Area</a></li>
<li><a href="../htmldom/dom_obj_base.asp" title="HTML DOM Base 对象">Base</a></li>
<li><a href="../htmldom/dom_obj_body.asp" title="HTML DOM Body 对象">Body</a></li>
<li><a href="../htmldom/dom_obj_pushbutton.asp" title="HTML DOM Button 对象">Button</a></li>
<li><a href="../htmldom/dom_obj_canvas.asp" title="HTML DOM Canvas 对象">Canvas</a></li>
<li><a href="../htmldom/dom_obj_event.asp" title="HTML DOM Event 对象">Event</a></li>
<li><a href="../htmldom/dom_obj_form.asp" title="HTML DOM Form 对象">Form</a></li>
<li><a href="../htmldom/dom_obj_frame.asp" title="HTML DOM Frame 对象">Frame</a></li>
<li><a href="../htmldom/dom_obj_frameset.asp" title="HTML DOM Frameset 对象">Frameset</a></li>
<li><a href="../htmldom/dom_obj_iframe.asp" title="HTML DOM IFrame 对象">IFrame</a></li>
<li><a href="../htmldom/dom_obj_image.asp" title="HTML DOM Image 对象">Image</a></li>
<li><a href="../htmldom/dom_obj_button.asp" title="HTML DOM Button 对象">Input Button</a></li>
<li><a href="../htmldom/dom_obj_checkbox.asp" title="HTML DOM Checkbox 对象">Input Checkbox</a></li>
<li><a href="../htmldom/dom_obj_fileupload.asp" title="HTML DOM FileUpload 对象">Input File</a></li>
<li><a href="../htmldom/dom_obj_hidden.asp" title="HTML DOM Hidden 对象">Input Hidden</a></li>
<li><a href="../htmldom/dom_obj_password.asp" title="HTML DOM Password 对象">Input Password</a></li>
<li><a href="../htmldom/dom_obj_radio.asp" title="HTML DOM Radio 对象">Input Radio</a></li>
<li><a href="../htmldom/dom_obj_reset.asp" title="HTML DOM Reset 对象">Input Reset</a></li>
<li><a href="../htmldom/dom_obj_submit.asp" title="HTML DOM Submit 对象">Input Submit</a></li>
<li><a href="../htmldom/dom_obj_text.asp" title="HTML DOM Text 对象">Input Text</a></li>
<li><a href="../htmldom/dom_obj_link.asp" title="HTML DOM Link 对象">Link</a></li>
<li><a href="../htmldom/dom_obj_meta.asp" title="HTML DOM Meta 对象">Meta</a></li>
<li><a href="../htmldom/dom_obj_object.asp" title="HTML DOM Object 对象">Object</a></li>
<li><a href="../htmldom/dom_obj_option.asp" title="HTML DOM Option 对象">Option</a></li>
<li><a href="../htmldom/dom_obj_select.asp" title="HTML DOM Select 对象">Select</a></li>
<li><a href="../htmldom/dom_obj_style.asp" title="HTML DOM Style 对象">Style</a></li>
<li><a href="../htmldom/dom_obj_table.asp" title="HTML DOM Table 对象">Table</a></li>
<li><a href="../htmldom/dom_obj_tabledata.asp" title="HTML DOM TableCell 对象">TableCell</a></li>
<li><a href="../htmldom/dom_obj_tablerow.asp" title="HTML DOM TableRow 对象">TableRow</a></li>
<li><a href="../htmldom/dom_obj_textarea.asp" title="HTML DOM Textarea 对象">Textarea</a></li>
</ul>
</div>
...
<ul>
<li><a href="pro_js_object_oriented.asp" title="ECMAScript 面向对象技术">面向对象技术</a></li>
