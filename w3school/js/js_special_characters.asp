...
<h1>JavaScript 特殊字符</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="js_onerror.asp">Previous Page</a></li>

<li class="next"><a href="js_guidelines.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>你可以在 JavaScript 中使用反斜杠来向文本字符串添加特殊字符。</strong></p>
</div>

<div>
<h2>插入特殊字符</h2>
<p>反斜杠用来在文本字符串中插入省略号、换行符、引号和其他特殊字符。</p>
<p>请看下面的 JavaScript 代码：</p>
<pre>var txt=&quot;We are the so-called <code>&quot;Vikings&quot;</code> from the north.&quot;
document.write(txt)</pre>
<p>在 JavaScript 中，字符串使用单引号或者双引号来起始或者结束。这意味着上面的字符串将被截为：We are the so-called。</p>
<p>要解决这个问题，就必须把在 &quot;Viking&quot; 中的引号前面加上反斜杠 (\)。这样就可以把每个双引号转换为字面上的字符串。</p>
<pre>var txt=&quot;We are the so-called <code>\&quot;Vikings\&quot;</code> from the north.&quot;
document.write(txt)</pre>
<p>现在 JavaScript 就可以输出正确的文本字符串了：We are the so-called &quot;Vikings&quot; from the north。</p>
<p>这是另一个例子：</p>
<pre>document.write (&quot;You <code>\&amp;</code> me are singing!&quot;)&nbsp;</pre>
<p>上面的例子会产生以下输出：</p>
<pre>You &amp; me are singing!</pre>
