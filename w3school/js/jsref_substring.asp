...
<h3>语法</h3>
<pre>stringObject.substring(start,stop)</pre>
...
<p>如果参数 start 与 end 相等，那么该方法返回的就是一个空串（即长度为 0 的字符串）。如果 start 比 end 大，那么该方法在提取子串之前会先交换这两个参数。</p>
</div>


<div>
<h2>提示和注释</h2>
<p class="important"><span>重要事项：</span>与 slice() 和 substr() 方法不同的是，substring() 不接受负的参数。</p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="../tiy/t.asp@f=jseg_substring">substring()</a></dt>
<dd>如何使用 substring() 从字符串中提取一些字符。</dd>
</dl>
</div>
