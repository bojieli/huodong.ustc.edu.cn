...
<p><a href="jsref_obj_array.asp" title="JavaScript Array 对象参考手册">JavaScript Array 对象参考手册</a></p>
</div>
...
<h3>语法</h3>
<pre>arrayObject.sort(sortby)</pre>
...
<h2>TIY</h2>
<dl>
<dt><a href="../tiy/t.asp@f=jseg_sort_1">sort() 按字母顺序</a></dt>
<dd>如何使用 sort() 按照字母顺序对数组进行排序。</dd>
<dt><a href="../tiy/t.asp@f=jseg_sort_2">sort() 按数值顺序</a></dt>
<dd>如何使用 sort() 按照数值顺序对数组进行排序。</dd>
</dl>
</div>
