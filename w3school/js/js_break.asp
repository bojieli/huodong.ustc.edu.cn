...
<title>JavaScript Break 和 Continue</title>
</head>
...
<div id="maincontent">
<h1>JavaScript Break 和 Continue</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="js_loop_while.asp">Previous Page</a></li>

<li class="next"><a href="js_loop_for_in.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>有两种可以用在循环中的语句：break 和 continue。</strong></p>
</div>
...
<dd>使用 break 语句来终止循环。</dd>
<dt><a href="../tiy/t.asp@f=jseg_continue">continue 语句</a></dt>
<dd>使用 continue 语句来终止当前的循环，然后从下一个值继续执行。</dd>
</dl>
</div>

<div>
<h2>JavaScript break 和 continue 语句</h2>
<p>有两种特殊的语句可用在循环内部：break 和 continue。</p>
<h3>Break</h3>
<p>break 命令可以终止循环的运行，然后继续执行循环之后的代码（如果循环之后有代码的话）。</p>
<h3>实例：</h3>
<pre>&lt;html&gt;
&lt;body&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
...
The number is 2</pre>
<h3>Continue</h3>
<p>continue 命令会终止当前的循环，然后从下一个值继续运行。</p>
<h3>实例：</h3>
<pre>&lt;html&gt;
&lt;body&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
