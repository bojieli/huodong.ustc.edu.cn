...
<title>JavaScript Throw 声明</title>
</head>
...
<div id="maincontent">
<h1>JavaScript Throw 声明</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="js_try_catch.asp">Previous Page</a></li>

<li class="next"><a href="js_onerror.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>throw 声明的作用是创建 exception（异常或错误）。</strong></p>
</div>
...
<div>
<h2>Throw 声明</h2>
<p>throw 声明的作用是创建 exception（异常）。你可以把这个声明与 try...catch 声明配合使用，以达到控制程序流并产生精确错误消息的目的。</p>
<h3>语法：</h3>
<pre>throw(exception)</pre>
<p>exception 可以是字符串、整数、逻辑值或者对象。</p>
<p class="important"><span>注意：</span>使用小写字母编写 throw。使用大写字母会出错！</p>
<h3>实例 1</h3>
<p>下面的实例的作用是测定变量 x 的值。如果 x 的值大于 10 或者小于 0，错误就会被抛出 (throw)。这个错误被 catch 的参数捕获后，就会显示出自定义的出错信息。</p>
<pre>&lt;html&gt;
&lt;body&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
...
{ 
if(x&gt;10) 
<code>throw &quot;Err1&quot;</code>
else if(x&lt;0)
<code>throw &quot;Err2&quot;</code>
} 
<code>catch(er)</code>
{
if(er==&quot;Err1&quot;) 
