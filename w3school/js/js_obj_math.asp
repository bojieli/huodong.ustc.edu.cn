...
<li class="pre"><a href="js_obj_boolean.asp">Previous Page</a></li>

<li class="next"><a href="js_obj_regexp.asp">Next Page</a></li>
</ul>
...
<p>我们提供 <a href="jsref_obj_math.asp">JavaScript Math 对象的参考手册</a>，其中包括所有可用于算术对象的属性和方法。</p>
