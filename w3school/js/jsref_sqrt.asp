...
<p><a href="jsref_obj_math.asp" title="JavaScript Math 对象参考手册">JavaScript Math 对象参考手册</a></p>
</div>
...
<h3>返回值</h3>
<p>参数 x 的平方根。如果 x 小于 0，则返回 NaN。</p>
</div>

<div>
<h3>提示和注释</h3>
<p class="tip"><span>提示：</span>Math.pow() 方法可以计算一个数的任意次根。</p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="../tiy/t.asp@f=jseg_sqrt">sqrt()</a></dt>
<dd>如何使用 sqrt() 来计算一些数字的平方根。</dd>
</dl>
</div>
