...
<li class="pre"><a href="../example/jsrf_examples.asp">Previous Page</a></li>

<li class="next"><a href="js_reference.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>您可以通过 W3SCHOOL 的测验程序来测试您的 JavaScript 技能。</strong></p>
</div>

<div>
<h2>关于本测验</h2>
<p>本测验包含 20 道题，每道题的最长答题时间是 20 分钟（这是由于每个 session 的默认有效时间是 20 钟）。</p>
<p>本测验是非官方的测试，它仅仅提供了一个了解您对 JavaScript 的掌握程度的工具。</p>
</div>

<div>
<h2>测验会被记分</h2>
<p>每道题的分值是 1 分。在您完成全部的 20 道题之后，系统会为您的测验打分，并提供您做错的题目的正确答案。其中，绿色为正确答案，而红色为错误答案。</p>
<p><a href="../quiz/quiz.asp@quiz=js">现在就开始测验</a>！祝您好运。</p>
</div>
