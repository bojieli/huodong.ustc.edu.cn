...
<li class="pre"><a href="pro_js_object_oriented.asp">Previous Page</a></li>

<li class="next"><a href="pro_js_object_types.asp">Next Page</a></li>
</ul>
...
<p>在前面的章节中，我们介绍了<a href="pro_js_referencetypes.asp" title="ECMAScript 引用类型">引用类型的概念</a>。在 ECMAScript 中，不能访问对象的物理表示，只能访问对象的引用。每次创建对象，存储在变量中的都是该对象的引用，而不是对象本身。</p>
</div>
