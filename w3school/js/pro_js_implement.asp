...
<li class="pre"><a href="pro_js_history.asp">Previous Page</a></li>

<li class="next"><a href="pro_js_syntax.asp">Next Page</a></li>
</ul>
...
<ul>
<li><a href="pro_js_implement.asp#ECMAScript">核心（ECMAScript）</a></li>
<li><a href="pro_js_implement.asp#DOM">文档对象模型（DOM）</a></li>
<li><a href="pro_js_implement.asp#BOM">浏览器对象模型（BOM）</a></li>
</ul>
...
<p>ECMAScript 分成几个不同的版本，它是在一个叫做 ECMA-262 的标准中定义的。和其他标准一样，ECMA-262 会被编辑和更新。当有了主要更新时，就会发布一个标准的新版。最新 ECMA-262 的版本是第三版，于 1999 年 12 月发布。</p>
...
<ul>
<li><a href="../htmldom/dom_obj_window.asp" title="HTML DOM Window 对象">Window 对象</a></li>
<li><a href="../htmldom/dom_obj_navigator.asp" title="HTML DOM Navigator 对象">Navigator 对象</a></li>
<li><a href="../htmldom/dom_obj_screen.asp" title="HTML DOM Screen 对象">Screen 对象</a></li>
<li><a href="../htmldom/dom_obj_history.asp" title="HTML DOM History 对象">History 对象</a></li>
<li><a href="../htmldom/dom_obj_location.asp" title="HTML DOM Location 对象">Location 对象</a></li>
</ul>
</div>
