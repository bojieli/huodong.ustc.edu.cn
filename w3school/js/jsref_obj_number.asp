...
<title>JavaScript Number 对象参考手册</title>
</head>
...
<h1>JavaScript Number 对象参考手册</h1>
...
<pre>var myNum=new Number(<i>value</i>);
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="jsref_nan_number.asp">NaN</a></td>
    <td>非数字值。</td>
    <td>1.0</td>
    <td>4.0</td>
  </tr>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="jsref_tofixed.asp">toFixed</a></td>
    <td>把数字转换为字符串，结果的小数点后有指定位数的数字。</td>
    <td>1.0</td>
    <td>5.5</td>
  </tr>
  <tr>
    <td><a href="jsref_toexponential.asp">toExponential</a></td>
    <td>把对象的值转换为指数计数法。</td>
    <td>1.0</td>
    <td>5.5</td>
  </tr>
  <tr>
    <td><a href="jsref_toprecision.asp">toPrecision</a></td>
    <td>把数字格式化为指定的长度。</td>
    <td>1.0</td>
    <td>5.5</td>
  </tr>
...
<pre>var n = 123;
var binary_value = n.toString(2);</pre>
</div>
