...
<li class="pre"><a href="js_form_validation.asp">Previous Page</a></li>

<li class="next"><a href="js_image_maps.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>我们可以使用 JavaScript 来创建动态的图像。</strong></p>
</div>
...
<dd>利用两个不同的事件来驱动两个相应的函数，来切换两张对应的图片以创造出动画效果。</dd>
</dl>
</div>

<div>
<h2>JavaScript 动画</h2>
<p>使用 JavaScript 创建动态图像是可行的。</p>
<p><em>窍门</em>是：使用 JavaScript 通过不同的事件来切换不同的图像。</p>
<p>在下面的例子中，我们要制作一个充当链接按钮的图像。我们将使用 onMouseOver 事件和 onMouseOut 事件来驱动 JavaScript 函数切换图像。</p>
</div>
...
<p>这是 HTML 代码：</p>
<pre>&lt;a href=&quot;http://www.w3school.com.cn&quot; target=&quot;_blank&quot;&gt;
...
<p class="important"><span>注意</span>：我们已为图像添加了 name 属性，这样 JavaScript 就能找到它了。</p>

<p>onMouseOver 事件的作用是告知浏览器：一旦鼠标悬浮于图像之上，浏览器就会执行某个函数，这个函数会把这副图像替换为另一幅。</p>
<p>onMouseOut 事件的作用是告知浏览器：一旦鼠标离开图像，浏览器就要执行另一个函数，这个函数会重新插入原来的那幅图像。</p>
</div>
...
<p>函数 mouseOver() 将图像切换为 &quot;eg_mouse.jpg&quot;。</p>
<p>函数 mouseOut() 将图像切换为 &quot;eg_mouse2.jpg&quot;。</p>
</div>
...
&lt;head&gt;
&lt;script type=&quot;text/javascript&quot;&gt;
function <code>mouseOver()</code>
  {
  document.b1.src =&quot;<code>/i/eg_mouse.jpg</code>&quot;
  }
function <code>mouseOut()</code>
  {
  document.b1.src =&quot;<code>/i/eg_mouse2.jpg</code>&quot;
  }
&lt;/script&gt;
&lt;/head&gt;
