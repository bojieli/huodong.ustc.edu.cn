...
<h1>JavaScript 对象简介</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="js_guidelines.asp">Previous Page</a></li>

<li class="next"><a href="js_obj_string.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>JavaScript 是面向对象的编程语言 (OOP)。</strong></p>
<p><strong>OOP 语言使我们有能力自定义对象和变量类型。</strong></p>
</div>

<div>
<h2>面向对象编程</h2>
<p>JavaScript 是面向对象的编程语言 (OOP)。OOP 语言使我们有能力定义自己的对象和变量类型。</p>
<p>别着急，我们会在高级 JavaScript 的部分讲解如何创建自己的对象。现在，我们要开始学习内建的 JavaScript 对象，以及如何使用它们。从下一节开始，我们将具体地依次讲解的这些内建的 JavaScript 对象。</p>
<p><em>注意</em>：对象只是一种特殊的数据。对象拥有属性和方法。</p>
</div>

<div>
<h2>属性</h2>
<p><strong>属性指与对象有关的值。</strong></p>
<p>在下面的例子中，我们使用字符串对象的长度属性来计算字符串中的字符数目。</p>
<pre>&lt;script type=&quot;text/javascript&quot;&gt;

var txt=&quot;Hello World!&quot;
document.write(txt.<code>length</code>)
...
<div>
<h2>方法</h2>
<p><strong>方法指对象可以执行的行为（或者可以完成的功能）。</strong></p>
<p>在下面的例子中，我们使用字符串对象的 toUpperCase() 方法来显示大写字母文本。</p>
<pre>&lt;script type=&quot;text/javascript&quot;&gt;

var str=&quot;Hello world!&quot;
document.write(str.<code>toUpperCase()</code>)
