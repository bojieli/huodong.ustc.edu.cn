...
<p><a href="jsref_obj_number.asp" title="JavaScript Number 对象参考手册">JavaScript Number 对象参考手册</a></p>
</div>
...
<p>在 ECMAScript v1 和其后的版本中，还可以用<a href="jsref_nan.asp" title="JavaScript NaN 属性">预定义的全局属性 NaN</a> 代替 Number.NaN。</p>
</div>
...
<div>
<h2>相关页面</h2>
<p>JavaScript 全局对象参考手册：<a href="jsref_nan.asp" title="JavaScript NaN 属性">NaN 属性</a></p>
<p>JavaScript 全局对象参考手册：<a href="jsref_isnan.asp" title="JavaScript isNaN() 函数">isNaN() 函数</a></p>
</div>
