...
<li class="next"><a href="js_intro.asp">Next Page</a></li>
</ul>
...
<p><a href="js_intro.asp" title="JavaScript 简介">开始学习 JavaScript</a> ！</p>
</div>
...
<p><a href="js_quiz.asp" title="JavaScript 测验">开始 JavaScript 测验</a> ！</p>
</div>

<div>
<h2>JavaScript 参考手册</h2>
<p>在 W3School，我们为您提供完整的 JavaScript 对象参考手册。</p>
<p><a href="js_reference.asp" title="JavaScript objects reference">完整的 JavaScript 对象参考手册（包含实例）</a></p>
...
<p>如果您已经把我们的 JavaScript 教程学习完毕，并且需要更深入地学习这门语言，那么 w3school 提供的 《<a href="index_pro.asp" title="JavaScript 高级教程">JavaScript 高级教程</a>》绝对是您最好的选择。</p>
...
<p><a href="index_pro.asp" title="JavaScript 高级教程">马上开始学习 JavaScript 高级教程吧</a> ！</p>
</div>
