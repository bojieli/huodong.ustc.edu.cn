...
<li class="pre"><a href="js_if_else.asp">Previous Page</a></li>

<li class="next"><a href="js_popup.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>JavaScript 中的条件语句用于完成基于不同条件的行为。</strong></p>
</div>

<div class="example">
<h2>实例</h2>
<dl>
<dt><a href="../tiy/t.asp@f=jseg_switch">Switch 语句</a></dt>
<dd>如何编写一个 Switch 语句。</dd>
</dl>
</div>

<div>
<h2>JavaScript Switch 语句</h2>
<p>如果希望选择执行若干代码块中的一个，你可以使用 switch 语句：</p>
<h3>语法：</h3>
<pre>
<code>switch(n)</code>
   {
...
<p><em>工作原理</em>：switch 后面的 (n) 可以是表达式，也可以（并通常）是变量。然后表达式中的值会与 case 中的数字作比较，如果与某个 case 相匹配，那么其后的代码就会被执行。<em>break</em> 的作用是防止代码自动执行到下一行。</p>
<h3>实例：</h3>
