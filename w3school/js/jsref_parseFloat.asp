...
<p><a href="jsref_obj_global.asp" title="JavaScript 全局对象参考手册">JavaScript 全局对象参考手册</a></p>
</div>
...
<h2>TIY</h2>
<dl>
<dt><a href="../tiy/t.asp@f=jseg_parseFloat">parseFloat()</a></dt>
<dd>如何使用 parseFloat() 来解析不同的字符串。</dd>
</dl>
</div>
