...
<h1>如何实现 JavaScript</h1>

<div id="tpn">
<ul class="prenext">

<li class="pre"><a href="js_intro.asp">Previous Page</a></li>

<li class="next"><a href="js_whereto.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>HTML 的 &lt;script&gt; 标签用于把 JavaScript 插入 HTML 页面当中。</strong></p>
</div>
...
<dd>如何使用 JavaScript 在页面中写入普通文本和标签。</dd>
</dl>
</div>

<div>
<h2>如何把 JavaScript 放入 HTML 页面</h2>
<pre>&lt;html&gt;
&lt;body&gt;
...
&lt;/html&gt;</pre>
<p>上面的代码会在 HTML 页面中产生这样的输出：</p>
<pre>Hello World! </pre>
<h3>实例解释：</h3>
<p>如果需要把一段 JavaScript 插入 HTML 页面，我们需要使用 &lt;script&gt; 标签（同时使用 type 属性来定义脚本语言）。</p>
<p>这样，&lt;script type=&quot;text/javascript&quot;&gt; 和 &lt;/script&gt; 就可以告诉浏览器 JavaScript 从何处开始，到何处结束。</p>
<pre>&lt;html&gt;
&lt;body&gt;
<code>&lt;script type=&quot;text/javascript&quot;&gt;
...
...
&lt;/body&gt;
&lt;/html&gt;</pre>
<p><em>document.write</em> 字段是标准的 JavaScript 命令，用来向页面写入输出。</p>
<p>把 document.write 命令输入到 &lt;script type=&quot;text/javascript&quot;&gt;与&lt;/script&gt;之间后，浏览器就会把它当作一条 JavaScript 命令来执行。这样浏览器就会向页面写入 &quot;Hello World!&quot;。</p>
<pre>&lt;html&gt;
&lt;body&gt;
<code>&lt;script type=&quot;text/javascript&quot;&gt;
document.write(&quot;Hello World!&quot;);
...
<p><a href="../tiy/t.asp@f=jseg_text">TIY</a></p>

<p class="note"><span>注意：</span>如果我们不使用 &lt;script&gt; 标签，浏览器就会把 document.write(&quot;Hello World!&quot;) 当作纯文本来处理，也就是说会把这条命令本身写到页面上。</p>

<p><a href="../tiy/t.asp@f=jseg_text_err">TIY</a></p>
</div>

<div>
<h2>如何与老的浏览器打交道</h2>
<p>那些不支持 JavaScript 的浏览器会把脚本作为页面的内容来显示。为了防止这种情况发生，我们可以使用这样的 HTML 注释标签：</p>
<pre>&lt;html&gt;
&lt;body&gt;
<code>&lt;script type=&quot;text/javascript&quot;&gt;
&lt;!--
...
<p>注释行末尾的两个正斜杠是 JavaScript 的注释符号，它会阻止 JavaScript 编译器对这一行的编译。</p>
</div>
