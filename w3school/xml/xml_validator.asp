...
<li class="pre"><a href="xml_dtd.asp">Previous Page</a></li>

<li class="next"><a href="xml_browsers.asp">Next Page</a></li>
</ul>
...
<form action="http://www.w3school.com.cn/xml/validator.asp" target="_blank" method="post">
<label>文件名:</label>
