...
<li class="pre"><a href="html_colors.asp">Previous Page</a></li>

<li class="next"><a href="html_colornames.asp">Next Page</a></li>
</ul>
...
<div>
<h2>关闭红色</h2>
<p>如果将红色完全关闭,绿色和蓝色的组合有 65536 种（256 x 256）。</p>
<p><a href="html_colorsmore.asp@color=0">单击此处</a>查看绿色和蓝色的不同组合。</p>
</div>

<div>
<h2>打开红色</h2>
<p>如果将红色设置为最大值,那么仍然存在 65536 种绿色和蓝色的不同组合。</p>
<p><a href="html_colorsmore.asp@color=255">单击此处</a>查看绿色和蓝色的不同组合。</p>
</div>
...
<p>你可以查看下面的色表，你会看到当绿色和蓝色的值为零时，红色值从 0 到 255 时的具体的颜色。</p>
<p>如需查看基于红色从 0 到 255 变化时的 16384 种不同的颜色，请单击下面的十六进制值或者 rgb 颜色值：</p>
...
<div>
<h2>灰阶</h2>
<p>当所有颜色取相等的值时，灰色就可以被显示出来。为了使您更容易地选择合适的灰色，我们为您制作了一幅灰阶色表。</p>

<table class="dataintable">
<tr>
<th style="width:50%">灰色</th>
<th style="width:25%">RGB</th>
<th style="width:25%">HEX</th>
</tr>
