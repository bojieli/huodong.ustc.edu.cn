...
<table class="dataintable">
  ...
  <tr>
    <td><a href="coll_doc_all.asp">all[]</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="met_doc_getelementbyid.asp">getElementById()</a></td>
...
<p>这些集合属性都源自于 0 级 DOM。它们已经被 <a href="met_doc_getelementsbytagname.asp">Document.getElementsByTagName()</a> 所取代，但是仍然常常使用，因为他们很方便。</p>

<p><a href="met_doc_write.asp">write() 方法</a>值得注意，在文档载入和解析的时候，它允许一个脚本向文档中插入动态生成的内容。</p>

<p>注意，在 1 级 DOM 中，HTMLDocument 定义了一个名为 <a href="met_doc_getelementbyid.asp">getElementById()</a> 的非常有用的方法。在 2 级 DOM 中，该方法已经被转移到了 Document 接口，它现在由 HTMLDocument 继承而不是由它定义了。</p>
</div>
