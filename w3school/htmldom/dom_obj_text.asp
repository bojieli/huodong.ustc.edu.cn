...
<meta name="description" content="HTML DOM Text 对象的定义、对其属性方法的简要描述，并提供了指向具体属性和方法的链接。" />
...
<p>您可以使用 HTML &lt;textarea&gt; 标记来创建多行文本输入。参阅 <a href="dom_obj_textarea.asp">Textarea 对象</a>。</p>
<p>对于掩码文本输入，把 &lt;input type=&quot;text&quot;&gt; 中的 type 设置为 &quot;password&quot;。参阅 <a href="dom_obj_password.asp">Input Password</a>。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="prop_text_accesskey.asp">accessKey</a></td>
  ...
  <tr>
    <td><a href="prop_text_alt.asp">alt</a></td>
  ...
  <tr>
    <td><a href="prop_text_id.asp">id</a></td>
    <td>设置或返回文本域的 id。</td>
    <td>4</td>
    <td>1</td>
    <td>9</td>
  ...
  <tr>
    <td><a href="prop_text_tabindex.asp">tabIndex</a></td>
