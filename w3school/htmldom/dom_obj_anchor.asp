...
<meta name="description" content="HTML DOM Anchor 对象的定义、用法、语法、属性、方法，以及指向具体属性和方法的链接。" />
...
<p class="note"><span>IE:</span> Internet Explorer, <span>F:</span> Firefox, <span>O:</span> Opera, <span>W3C:</span> W3C 标准.</p>
</div>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="prop_anchor_accesskey.asp">accessKey</a></td>
  ...
  <tr>
    <td><a href="prop_anchor_charset.asp">charset</a></td>
  ...
  <tr>
    <td><a href="prop_anchor_coords.asp">coords</a></td>
  ...
  <tr>
    <td><a href="prop_anchor_innerhtml.asp">innerHTML</a></td>
    <td>设置或返回一个链接的内容。</td>
    <td>4</td>
    <td>1</td>
    <td>9</td>
  ...
  <tr>
    <td><a href="prop_anchor_name.asp">name</a></td>
    <td>设置或返回一个链接的名称。</td>
    <td>4</td>
    <td>1</td>
    <td>9</td>
  ...
  <tr>
    <td><a href="prop_anchor_rev.asp">rev</a></td>
  ...
  <tr>
    <td><a href="prop_anchor_shape.asp">shape</a></td>
  ...
  <tr>
    <td><a href="prop_anchor_tabindex.asp">tabIndex</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="prop_classname.asp">className</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="met_anchor_blur.asp">blur()</a></td>
    <td>把焦点从链接上移开。</td>
    <td>5</td>
    <td>1</td>
    <td>9</td>
  ...
  <tr>
    <td><a href="met_anchor_focus.asp">focus()</a></td>
    <td>给链接应用焦点。</td>
    <td>5</td>
    <td>1</td>
    <td>9</td>
