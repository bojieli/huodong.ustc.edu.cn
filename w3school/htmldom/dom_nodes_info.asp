...
<li class="pre"><a href="dom_nodes_access.asp">Previous Page</a></li>

<li class="next"><a href="dom_example.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>nodeName、nodeValue 以及 nodeType 包含有关于节点的信息。</strong></p>
</div>

<div>
<h2>节点信息</h2>
<p>每个节点都拥有包含着关于节点某些信息的属性。这些属性是：</p>
<ul>
<li>nodeName（节点名称）</li>
<li>nodeValue（节点值）</li>
<li>nodeType（节点类型）</li>
