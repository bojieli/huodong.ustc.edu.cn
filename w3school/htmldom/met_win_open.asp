...
<p><a href="dom_obj_window.asp">HTML DOM Window 对象参考手册</a></p>
</div>
...
<table class="dataintable"> 
  ...
  <tr>
    <td>features</td>
    <td>一个可选的字符串，声明了新窗口要显示的标准浏览器的特征。如果省略该参数，新窗口将具有所有标准特征。在<a href="met_win_open.asp#windowfeatures">窗口特征</a>这个表格中，我们对该字符串的格式进行了详细的说明。</td>
  </tr>
    <tr>
    <td>replace<p></td>
    <td>
