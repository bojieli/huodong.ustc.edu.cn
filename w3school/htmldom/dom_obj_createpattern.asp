...
<p>CanvasPattern 对象由 <a href="dom_obj_canvasrenderingcontext2d.asp" title="HTML DOM CanvasRenderingContext2D 对象">CanvasRenderingContext2D 对象</a>的 <a href="met_canvasrenderingcontext2d_createpattern.asp" title="HTML DOM createPattern() 方法">createPattern() 方法</a>返回。</p>

<p>一个 CanvasPattern 对象可以用作 CanvasRenderingContext2D 对象的 strokeStyle 和 fillStyle 属性的值。</p>

<p>CanvasPattern 对象没有自己的属性和方法。请参阅 <a href="met_canvasrenderingcontext2d_createpattern.asp" title="HTML DOM createPattern() 方法">CanvasRenderingContext2D.createPattern()</a> 详细了解如何创建这个对象。</p>
</div>
...
<p><a href="met_canvasrenderingcontext2d_createpattern.asp" title="HTML DOM createPattern() 方法">CanvasRenderingContext2D.createPattern()</a></p>
</div>
