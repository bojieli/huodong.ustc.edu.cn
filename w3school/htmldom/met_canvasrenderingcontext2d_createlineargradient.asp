...
<p>表示一个线性颜色渐变的一个 <a href="dom_obj_canvasgradient.asp" title="HTML DOM CanvasGradient 对象">CanvasGradient 对象</a>。</p>

<h3>描述</h3>

<p>这个方法创建并返回了一个新的 CanvasGradient 对象，它在指定的起始点和结束点之间线性地内插颜色值。注意，这个方法并没有为渐变指定任何颜色。使用返回对象的 <a href="met_canvasgradient_addcolorstop.asp" title="HTML DOM addColorStop() 方法">addColorStop()</a> 来做到这一点。要使用一个渐变来勾勒线条或填充区域，只需要把 CanvasGradient 对象赋给 strokeStyle 属性或 fillStyle 属性即可。</p>
</div>
