...
<li class="pre"><a href="dom_intro.asp">Previous Page</a></li>

<li class="next"><a href="dom_nodetree.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>HTML 文档中的每个成分都是一个节点。</strong></p>
</div>

<div>
<h2>节点</h2>
<p>根据 DOM，HTML 文档中的每个成分都是一个节点。</p>
<p>DOM 是这样规定的：</p>
<ul>
<li>整个文档是一个文档节点</li>
...
<h2>Node 层次</h2>
<p>节点彼此都有等级关系。</p>
<p>HTML 文档中的所有节点组成了一个文档树（或节点树）。HTML 文档中的每个元素、属性、文本等都代表着树中的一个节点。树起始于文档节点，并由此继续伸出枝条，直到处于这棵树最低级别的所有文本节点为止。</p>
<p>下面这个图片表示一个文档树（节点树）：</p>
<img src="../i/ct_htmltree.gif" alt="HTML树结构" />
</div>
