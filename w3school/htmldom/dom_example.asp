...
<li class="next"><a href="htmldom_reference.asp">Next Page</a></li>
</ul>

</div>

<div>
<h2>一个 HTML DOM 的实例</h2>
<p>下面这个例子向我们展示了当一个用户在文档中点击时，HTML 文档的背景颜色如何被改变。</p>
...
<p><a href="../tiy/t.asp@f=hdom_change_color">TIY</a></p>
</div>
