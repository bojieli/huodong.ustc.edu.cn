...
<meta name="description" content="HTML DOM Reset 对象的定义、对其属性方法的简要描述，并提供了指向具体属性和方法的链接。" />
...
<p>参阅 <a href="met_form_reset.asp">Form.reset() 方法</a> 和 <a href="prop_form_onreset.asp">Form.onreset</a> 事件句柄。</p>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="prop_reset_accesskey.asp">accesskey</a></td>
  ...
  <tr>
    <td><a href="prop_reset_alt.asp">alt</a></td>
  ...
  <tr>
    <td><a href="prop_reset_id.asp">id</a></td>
    <td>设置或返回重置按钮的 id。</td>
    <td>4</td>
    <td>1</td>
    <td>9</td>
  ...
  <tr>
    <td><a href="prop_reset_tabindex.asp">tabIndex</a></td>
