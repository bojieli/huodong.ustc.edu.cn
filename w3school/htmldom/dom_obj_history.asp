...
<div>
<h2>History 对象描述</h2>
<p>History 对象最初设计来表示窗口的浏览历史。但出于隐私方面的原因，History 对象不再允许脚本访问已经访问过的实际 URL。唯一保持使用的功能只有 <a href="met_his_back.asp">back()</a>、<a href="met_his_forward.asp">forward()</a> 和 <a href="met_his_go.asp">go()</a> 方法。</p>
