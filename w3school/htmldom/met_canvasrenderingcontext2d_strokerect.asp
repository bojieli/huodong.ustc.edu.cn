...
<p><a href="dom_obj_canvasrenderingcontext2d.asp" title="HTML DOM CanvasRenderingContext2D 对象">HTML DOM CanvasRenderingContext2D 对象参考手册</a></p>
</div>
...
<p>该方法按照指定的位置和大小绘制一个矩形的边框（但并不填充矩形的内部）。线条颜色和线条宽度由 strokeStyle 和 lineWidth 属性指定。矩形边角的形状由 <a href="prop_canvasrenderingcontext2d_linejoin.asp" title="HTML DOM lineJoin 属性">lineJoin 属性</a>指定。</p>

<p>strokeRect() 的当前实现会清晰化路径，就好像 <a href="met_canvasrenderingcontext2d_strokerect.asp" title="">beginPath()</a> 已经调用过了。这一令人吃惊的行为可能不会标准化，所以不能指望它。</p>
</div>

<div>
<h2>参阅</h2>

<p><a href="met_canvasrenderingcontext2d_fillrect.asp" title="HTML DOM fillRect() 方法">CanvasRenderingContext2D.fillRect()</a></p>
<p><a href="prop_canvasrenderingcontext2d_linejoin.asp" title="HTML DOM lineJoin 属性">CanvasRenderingContext2D.lineJoin</a></p>
<p><a href="met_canvasrenderingcontext2d_rect.asp" title="HTML DOM rect() 方法">CanvasRenderingContext2D.rect()</a></p>
<p><a href="met_canvasrenderingcontext2d_stroke.asp" title="HTML DOM stroke() 方法">CanvasRenderingContext2D.stroke()</a></p>
</div>
