...
<p>传递给 drawImage() 方法的图像必须是 <a href="dom_obj_image.asp" title="HTML DOM Image 对象">Image 对象</a>或 <a href="dom_obj_canvas.asp" title="HTML DOM Canvas 对象">Canvas 元素</a>。一个 Image 对象能够表示文档中的一个 <a href="../tags/tag_img.asp" title="HTML &lt;img&gt; 标签">&lt;img&gt; 标记</a>或者使用 Image() 构造函数所创建的一个屏幕外图像。</p>
</div>
...
<p><a href="dom_obj_image.asp" title="HTML DOM Image 对象">Image</a></p>
</div>
