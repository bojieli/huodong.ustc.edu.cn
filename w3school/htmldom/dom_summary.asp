...
<title>您已经学习了 HTML DOM，接下来的学习内容是什么呢？</title>
</head>
...
<h1>您已经学习了 HTML DOM，接下来的学习内容是什么呢？</h1>

<div  id="tpn">
<ul class="prenext">

<li class="pre"><a href="htmldom_reference.asp">Previous Page</a></li>

<li class="next"><a href="../example/hdom_examples.asp">Next Page</a></li>
</ul>
...
<div>
<h2>HTML DOM 概要</h2>
<p>本教程已经向您讲授了如何使用 HTML DOM 提高您的网站的动态性和交互性。</p>
<p>您已经学习了操作 HTML 元素来对不同的情况作出响应。</p>
<p>如需更多有关 HTML DOM 的信息，请访问我们的 <a href="../example/hdom_examples.asp">HTML DOM 实例</a> 和 <a href="htmldom_reference.asp">HTML DOM 参考手册</a>。</p>
</div>

<div>
<h2>现在您已经学习了 HTML DOM，下一步呢？</h2>
<p>下一步，您应当学习 ASP。</p>
<p>HTML 文件中的脚本是在客户端（浏览器中）执行的，而 ASP 文件中的脚本是在服务器上执行的。</p>
<p>通过 ASP，你可以动态地编辑、改变、添加网页的任何内容，对从 HTML 表单提交的信息作出响应，访问任何数据或者数据库并把结果返回浏览器，为不同的用户定制网页，使页面的可用性更强。</p>
<p>由于 ASP 文件所返回的内容是纯粹的 HTML，因此它们可显示于任何浏览器中。</p>
<p>如果您希望学习更多有关ASP的知识，请访问我们的 <a href="../asp/index.asp">ASP 教程</a>。</p>
</div>
