...
<meta name="description" content="本章是 HTML DOM Canvas 对象的参考手册，介绍了该对象的定义、用法、语法、属性、方法，并包含了指向具体方法的链接。" />
...
<p>你可以直接在该对象上指定宽度和高度，但是，其大多数功能都可以通过 <a href="dom_obj_canvasrenderingcontext2d.asp" title="HTML DOM CanvasRenderingContext2D 对象">CanvasRenderingContext2D 对象</a>获得。
这是通过 Canvas 对象的 <a href="met_canvas_getcontext.asp" title="HTML DOM getContext() 方法">getContext() 方法</a>并且把直接量字符串 &quot;2d&quot; 作为唯一的参数传递给它而获得的。</p>
...
<p><a href="../html5/tag_canvas.asp" title="HTML 5 &lt;canvas&gt; 标签">HTML 5 &lt;canvas&gt; 标签</a></p>

<p><a href="../html5/html_5_canvas.asp" title="HTML 5 Canvas">HTML 5 Canvas 教程</a></p>
