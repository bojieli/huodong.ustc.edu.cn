...
<li class="next"><a href="dom_nodes.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>HTML 文档对象模型（HTML Document Object Model）定义了访问和处理 HTML 文档的标准方法。</strong></p>
</div>

<div>
<h2>您应当具备的基础知识</h2>
<p>在继续学习之前，您需要对下面的知识有基本的了解：
<ul>
<li>HTML / XHTML</li>
<li>JavaScript</li>
</ul>
...
<div>
<h2>什么是 DOM？</h2>
<p>通过 JavaScript，您可以重构整个 HTML 文档。您可以添加、移除、改变或重排页面上的项目。</p>
<p>要改变页面的某个东西，JavaScript 就需要获得对 HTML 文档中所有元素进行访问的入口。这个入口，连同对 HTML 元素进行添加、移动、改变或移除的方法和属性，都是通过文档对象模型来获得的（DOM）。</p>
<p>在 1998 年，W3C 发布了第一级的 DOM 规范。这个规范允许访问和操作 HTML 页面中的每一个单独的元素。</p>
<p>所有的浏览器都执行了这个标准，因此，DOM 的兼容性问题也几乎难觅踪影了。</p>
<p>DOM 可被 JavaScript 用来读取、改变 HTML、XHTML 以及 XML 文档。</p>

<h3>DOM 被分为不同的部分（核心、XML及HTML）和级别（DOM Level 1/2/3）：</h3>
<dl class="define">
<dt>Core DOM</dt>
<dd>定义了一套标准的针对任何结构化文档的对象</dd>
<dt><a href="../xmldom/index.asp" title="XML DOM 教程">XML DOM</a></dt>
<dd>定义了一套标准的针对 XML 文档的对象</dd>
<dt>HTML DOM</dt>
<dd>定义了一套标准的针对 HTML 文档的对象。</dd>
</dl>
<p>您可以在我们的《<a href="../w3c/w3c_dom.asp" title="W3C DOM 活动">W3C教程</a>》阅读更多有关 W3C DOM 规范/级别的信息。</p>
</div>
