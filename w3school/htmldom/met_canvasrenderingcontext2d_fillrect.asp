...
<h3>语法</h3>
<pre>fillRect(<i>x</i>, <i>y</i>, <i>weight</i>, <i>height</i>)</pre>
...
<p>fillRect() 方法的当前实现还清除了路径，就好像 <a href="met_canvasrenderingcontext2d_beginpath.asp" title="HTML DOM beginPath() 方法">beginPath()</a> 已经调用了。这一令人惊讶的行为可能不会标准化，因此不应该指望它。</p>
</div>
...
<p><a href="met_canvasrenderingcontext2d_fill.asp" title="HTML DOM fill() 方法">CanvasRenderingContext2D.fill()</a></p>
<p><a href="met_canvasrenderingcontext2d_rect.asp" title="HTML DOM rect() 方法">CanvasRenderingContext2D.rect()</a></p>
<p><a href="met_canvasrenderingcontext2d_strokerect.asp" title="HTML DOM strokeRect() 方法">CanvasRenderingContext2D.strokeRect()</a></p>
</div>
