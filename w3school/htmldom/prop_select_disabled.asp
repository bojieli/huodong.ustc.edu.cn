...
<p><a href="dom_obj_select.asp">HTML DOM Select 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>disabled 属性可设置或返回是否金融下拉列表。</p>

<h3>语法</h3>
<pre>selectObject.disabled=true|false</pre>
</div>
...
function disable()
  {
  <code>document.getElementById(&quot;mySelect&quot;).disabled=true</code>
  }
function enable()
  {
  <code>document.getElementById(&quot;mySelect&quot;).disabled=false</code>
  }
&lt;/script&gt;
&lt;/head&gt;
&lt;body&gt;
