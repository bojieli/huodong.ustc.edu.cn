...
<li class="next"><a href="dom_intro.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>HTML DOM 定义了访问和操作HTML文档的标准方法。</strong></p>
<p><strong>HTML DOM 把 HTML 文档呈现为带有元素、属性和文本的树结构（节点树）。</strong></p>
<p><a href="dom_intro.asp" title="HTML DOM 简介">开始学习 HTML DOM</a>！</p>
<img src="../i/ct_htmltree.gif" alt="DOM HTML TREE" />
</div>

<div>
<h2>HTML DOM 实例</h2>
<p>学习 100 个实例！使用我们的编辑器，你可以编辑 HTML 文档，然后单击 TIY 按钮来查看结果。</p>
<p><a href="../example/hdom_examples.asp" title="HTML DOM 实例">HTML DOM 实例</a></p>
</div>

<div>
<h2>HTML DOM 参考手册</h2>
<p>在 W3School，我们为您准备了完整的 HTML DOM 参考手册。</p>
<p><a href="htmldom_reference.asp">HTML DOM 参考手册</a></p>
</div>
