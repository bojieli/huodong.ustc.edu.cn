...
<meta name="description" content="HTML DOM Radio 对象的定义、对其属性方法的简要描述，并提供了指向具体属性和方法的链接。" />
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="prop_radio_accesskey.asp">accessKey</a></td>
  ...
  <tr>
    <td><a href="prop_radio_alt.asp">alt</a></td>
  ...
  <tr>
    <td><a href="prop_radio_id.asp">id</a></td>
    <td>设置或返回单选按钮的 id。</td>
    <td>4</td>
    <td>1</td>
    <td>9</td>
  ...
  <tr>
    <td><a href="prop_radio_tabindex.asp">tabIndex</a></td>
...
<table class="dataintable">
  ...
  <tr>
    <td><a href="met_radio_click.asp">click()</a></td>
