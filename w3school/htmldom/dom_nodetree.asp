...
<li class="pre"><a href="dom_nodes.asp">Previous Page</a></li>
...
<div id="intro">
<p><strong>一棵节点树中的所有节点彼此都是有关系的。</strong></p>
</div>
...
<p>上面所有的节点彼此间都存在<em>关系</em>。</p>
<p>除文档节点之外的每个节点都有<em>父节点</em>。举例，&lt;head&gt; 和 &lt;body&gt; 的父节点是 &lt;html&gt; 节点，文本节点 &quot;Hello world!&quot; 的父节点是 &lt;p&gt; 节点。</p>
<p>大部分元素节点都有<em>子节点</em>。比方说，&lt;head&gt; 节点有一个子节点：&lt;title&gt; 节点。&lt;title&gt; 节点也有一个子节点：文本节点 &quot;DOM Tutorial&quot;。</p>
<p>当节点分享同一个父节点时，它们就是<em>同辈（同级节点）</em>。比方说，&lt;h1&gt; 和 &lt;p&gt;是同辈，因为它们的父节点均是 &lt;body&gt; 节点。</p>
<p>节点也可以拥有<em>后代</em>，后代指某个节点的所有子节点，或者这些子节点的子节点，以此类推。比方说，所有的文本节点都是 &lt;html&gt;节点的后代，而第一个文本节点是 &lt;head&gt; 节点的后代。</p>
<p>节点也可以拥有<em>先辈</em>。先辈是某个节点的父节点，或者父节点的父节点，以此类推。比方说，所有的文本节点都可把 &lt;html&gt; 节点作为先辈节点。</p>
</div>
