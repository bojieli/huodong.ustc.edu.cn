...
<h3>语法</h3>
<pre>createLinearGradient(<i>xStart</i>, <i>yStart</i>, <i>radiusStart</i>, <i>xEnd</i>, <i>yEnd</i>, <i>radiusEnd</i>)</pre>
...
<p>表示一个放射性颜色渐变的一个 <a href="dom_obj_canvasgradient.asp" title="HTML DOM CanvasGradient 对象">CanvasGradient 对象</a>。</p>

<h3>描述</h3>

<p>这个方法创建并返回了一个新的 CanvasGradient 对象，该对象在两个指定圆的圆周之间放射性地插值颜色。注意，这个方法并没有指定任何用来渐变的颜色。使用返回对象的 <a href="met_canvasgradient_addcolorstop.asp" title="HTML DOM addColorStop() 方法">addColorStop() 方法</a>做到这一点。要使用一个渐变来勾勒线条或填充区域，只需要把 CanvasGradient 对象赋给 strokeStyle 属性或 fillStyle 属性即可。</p>
...
<p><a href="met_canvasgradient_addcolorstop.asp" title="HTML DOM addColorStop() 方法">CanvasGradient.addColorStop()</a></p>
