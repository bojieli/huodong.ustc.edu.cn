...
<li class="pre"><a href="svg_path.asp">Previous Page</a></li>

<li class="next"><a href="svg_filters_gaussian.asp">Next Page</a></li>
</ul>

</div>

<div class="intro">
<p><strong>SVG 滤镜用来向形状和文本添加特殊的效果。</strong></p>
</div>
...
<p class="note"><span>注释：</span>您可以在每个 SVG 元素上使用多个滤镜！</p>
</div>
