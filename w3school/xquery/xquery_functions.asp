...
<li class="pre"><a href="xquery_select.asp">Previous Page</a></li>

<li class="next"><a href="xquery_summary.asp">Next Page</a></li>
</ul>
...
<div>
<h2>XQuery 用户定义函数</h2>
<p>如果找不到所需的 XQuery 函数，你可编写自己的函数。</p>
<p>可在查询中或独立的库中定义用户自定义函数。</p>

<h3>语法</h3>
<pre>declare function 前缀:函数名($参数 AS 数据类型)
  AS 返回的数据类型
{
...
&lt;minPrice&gt;{local:minPrice($book/price, $book/discount)}&lt;/minPrice&gt;</pre>
</div>
