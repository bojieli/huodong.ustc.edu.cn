...
<li class="pre"><a href="xquery_example.asp">Previous Page</a></li>

<li class="next"><a href="xquery_flwor_html.asp">Next Page</a></li>
</ul>
...
<div>
<h2>XML 实例文档</h2>
<p>我们将在下面的例子中使用这个 &quot;books.xml&quot; 文档（与上一节中的 XML 文件相同）。</p>
