...
<li class="pre"><a href="jquery_ref_manipulation.asp">Previous Page</a></li>

<li class="next"><a href="jquery_ref_css.asp">Next Page</a></li>
</ul>
...
<p class="note"><span>注释：</span><a href="jquery_ref_manipulation.asp">jQuery 文档操作参考手册</a>中也列出了以上方法。本参考页的作用是方便用户单独查阅有关属性操作方面的方法。</p>
</div>
