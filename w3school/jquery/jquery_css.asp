...
<li class="pre"><a href="jquery_html.asp">Previous Page</a></li>

<li class="next"><a href="jquery_ajax.asp">Next Page</a></li>
</ul>
...
<p>jQuery 拥有三种用于 CSS 操作的重要函数：</p>

<ul>
<li>$(selector).css(name,value)</li>
<li>$(selector).css({properties})</li>
<li>$(selector).css(name)</li>
</ul>
</div>
...
<p>函数 css(name,value) 为所有匹配元素的给定 CSS 属性设置值：</p>
...
<p>函数 css({properties}) 同时为所有匹配元素的一系列 CSS 属性设置值：</p>
...
<p><a href="../tiy/t.asp@f=jquery_css_change_p_and_font">亲自试一试</a></p>

<p>函数 css(name) 返回指定的 CSS 属性的值：</p>
...
<p>函数 height(value) 设置所有匹配元素的高度：</p>
...
<p><a href="../tiy/t.asp@f=jquery_css_change_height">亲自试一试</a></p>

<p>函数 width(value) 设置所有匹配元素的宽度：</p>
...
<p><a href="../tiy/t.asp@f=jquery_css_change_width">亲自试一试</a></p>
</div>


<div>
<h2>jQuery CSS 函数 - 来自本页</h2>
...
<tr>
<td>$(selector).css(name,value)</td>
<td>为匹配元素设置样式属性的值</td>
</tr>

<tr>
<td>$(selector).css({properties})</td>
<td>为匹配元素设置多个样式属性</td>
</tr>

<tr>
<td>$(selector).css(name)</td>
<td>获得第一个匹配元素的样式属性值</td>
</tr>
...
<p>如需完整的参考手册，请访问我们的 <a href="jquery_ref_css.asp" title="jQuery 参考手册 - HTML">jQuery CSS 函数参考手册</a>。</p>
</div>
