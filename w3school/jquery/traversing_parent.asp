...
<p>如果给定一个表示 DOM 元素集合的 jQuery 对象，.parent() 方法允许我们在 DOM 树中搜索这些元素的父元素，并用匹配元素构造一个新的 jQuery 对象。<a href="traversing_parents.asp">.parents()</a> 和 .parent() 方法类似，不同的是后者沿 DOM 树向上遍历单一层级。</p>
