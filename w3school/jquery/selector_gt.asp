...
<p><a href="jquery_ref_selectors.asp" title="jQuery 参考手册 - 选择器">jQuery 选择器参考手册</a></p>
</div>
...
<p class="tip"><span>提示：</span>请使用 <a href="selector_lt.asp" title="jQuery :lt 选择器">:lt 选择器</a>来选取 index 值小于指定数的元素。</p>
</div>
