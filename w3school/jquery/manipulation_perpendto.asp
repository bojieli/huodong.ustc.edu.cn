...
<p class="tip"><span>提示：</span><a href="manipulation_prepend.asp" title="jQuery 文档操作 - prepend() 方法">prepend()</a> 和 prependTo() 方法作用相同。差异在于语法：内容和选择器的位置，以及 prepend() 能够使用函数来插入内容。</p>
