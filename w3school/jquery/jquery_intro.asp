...
<li class="next"><a href="jquery_syntax.asp">Next Page</a></li>
</ul>

</div>

<div id="intro">
<p><strong>jQuery 库可以通过一行简单的标记被添加到网页中。</strong></p>
</div>
...
<div>
<h2>向您的页面添加 jQuery 库</h2>

<p>jQuery 库位于一个 JavaScript 文件中，其中包含了所有的 jQuery 函数。</p>

<p>可以通过下面的标记把 jQuery 添加到网页中：</p>
...
<p>下面的例子演示了 jQuery 的 hide() 函数，隐藏了 HTML 文档中所有的 &lt;p&gt; 元素。</p>
...
<p>共有两个版本的 jQuery 可供下载：一份是精简过的，另一份是未压缩的（供调试或阅读）。</p>

<p>这两个版本都可从 <a href="http://docs.jquery.com/Downloading_jQuery#Download_jQuery">jQuery.com</a> 下载。</p>
</div>
...
<p>Google 和 Microsoft 对 jQuery 的支持都很好。</p>

<p>如果您不愿意在自己的计算机上存放 jQuery 库，那么可以从 Google 或 Microsoft 加载 CDN jQuery 核心文件。</p>

<h3>使用 Google 的 CDN</h3>
