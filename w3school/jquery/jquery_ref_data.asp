...
<li class="pre"><a href="jquery_ref_traversing.asp">Previous Page</a></li>

<li class="next"><a href="jquery_ref_dom_element_methods.asp">Next Page</a></li>
</ul>
...
<tr>
<td><a href="data_clearqueue.asp" title="jQuery 数据 - clearQueue() 方法">.clearQueue()</a></td>
<td>从队列中删除所有未运行的项目。</td>
</tr>

<tr>
<td><a href="data_data.asp" title="jQuery 数据 - data() 方法">.data()</a></td>
<td>存储与匹配元素相关的任意数据。</td>
</tr>

<tr>
<td><a href="data_jquery_data.asp" title="jQuery 数据 - jQuery.data() 方法">jQuery.data()</a></td>
<td>存储与指定元素相关的任意数据。</td>
</tr>

<tr>
<td><a href="data_dequeue.asp" title="jQuery 数据 - dequeue() 方法">.dequeue()</a></td>
<td>从队列最前端移除一个队列函数，并执行它。</td>
</tr>

<tr>
<td><a href="data_jquery_dequeue.asp" title="jQuery 数据 - jQuery.dequeue() 方法">jQuery.dequeue()</a></td>
<td>从队列最前端移除一个队列函数，并执行它。</td>
</tr>

<tr>
<td><a href="data_hasdata.asp" title="jQuery 数据 - jQuery.hasData() 方法">jQuery.hasData()</a></td>
<td>存储与匹配元素相关的任意数据。</td>
</tr>

<tr>
<td><a href="data_queue.asp" title="jQuery 数据 - queue() 方法">.queue()</a></td>
<td>显示或操作匹配元素所执行函数的队列。</td>
</tr>

<tr>
<td><a href="data_jquery_queue.asp" title="jQuery 数据 - jQuery.queue() 方法">jQuery.queue()</a></td>
<td>显示或操作匹配元素所执行函数的队列。</td>
</tr>

<tr>
<td><a href="data_removedata.asp" title="jQuery 数据 - removeData() 方法">.removeData()</a></td>
<td>移除之前存放的数据。</td>
</tr>

<tr>
<td><a href="data_jquery_removedata.asp" title="jQuery 数据 - jQuery.removeData() 方法">jQuery.removeData()</a></td>
<td>移除之前存放的数据。</td>
</tr>
...
<p>参考手册：<a href="jquery_ref_queue.asp" title="jQuery 参考手册 - 队列控制">jQuery 队列控制</a></p>
</div>
