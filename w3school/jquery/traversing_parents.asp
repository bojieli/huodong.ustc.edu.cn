...
<p>如果给定一个表示 DOM 元素集合的 jQuery 对象，.parents() 方法允许我们在 DOM 树中搜索这些元素的祖先元素，并用从最近的父元素向上的顺序排列的匹配元素构造一个新的 jQuery 对象。元素是按照从最近的父元素向外的顺序被返回的。.parents() 和 <a href="traversing_parent.asp">.parent()</a> 方法类似，不同的是后者沿 DOM 树向上遍历单一层级。</p>
