...
<p class="tip"><span>提示：</span>prepend() 和 <a href="manipulation_perpendto.asp" title="jQuery 文档操作 - prependTo() 方法">prependTo()</a> 方法作用相同。差异在于语法：内容和选择器的位置，以及 prependTo() 无法使用函数来插入内容。</p>
