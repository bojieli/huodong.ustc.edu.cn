...
<p class="tip"><span>提示：</span>replaceAll() 与 <a href="manipulation_replacewith.asp" title="jQuery 文档操作 - replaceWith() 方法">replaceWith()</a> 作用相同。差异在于语法：内容和选择器的位置，以及 replaceWith() 能够使用函数进行替换。</p>
