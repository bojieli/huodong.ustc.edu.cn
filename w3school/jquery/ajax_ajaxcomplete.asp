...
<title>jQuery ajax - ajaxComplete() 方法</title>
</head>
...
<h1>jQuery ajax - ajaxComplete() 方法</h1>
...
<p><a href="../tiy/t.asp@f=jquery_ajax_ajaxcomplete">亲自试一试</a></p>
</div>
...
<p>ajaxComplete() 方法在 AJAX 请求完成时执行函数。它是一个 Ajax 事件。</p>

<p>与 ajaxSuccess() 不同，通过 ajaxComplete() 方法规定的函数会在请求完成时运行，即使请求并未成功。</p>

<h3>语法</h3>

<pre>.jQueryajaxComplete(<i>function(event,xhr,options)</i>)</pre>
