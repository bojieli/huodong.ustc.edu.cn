...
<p class="tip"><span>提示：</span>replaceWith() 与 <a href="manipulation_replaceall.asp" title="jQuery 文档操作 - replaceAll() 方法">replaceAll()</a> 作用相同。差异在于语法：内容和选择器的位置，以及 replaceAll() 无法使用函数进行替换。</p>
