...
<title>jQuery 效果 - slideToggle() 方法</title>
</head>
...
<h1>jQuery 效果 - slideToggle() 方法</h1>

<div class="backtoreference">
<p><a href="jquery_ref_effects.asp" title="jQuery 参考手册 - 效果">jQuery 效果参考手册</a></p>
</div>
...
<p>通过使用滑动效果，在显示和隐藏状态之间切换 &lt;p&gt; 元素：</p>

<pre>
$(&quot;.btn1&quot;).click(function(){
  <code>$(&quot;p&quot;).slideToggle();</code>
});
</pre>

<p><a href="../tiy/t.asp@f=jquery_effect_slidetoggle">亲自试一试</a></p>
</div>
...
<p>slideToggle() 方法通过使用滑动效果（高度变化）来切换元素的可见状态。</p>

<p>如果被选元素是可见的，则隐藏这些元素，如果被选元素是隐藏的，则显示这些元素。</p>
...
<td>
	...
	<p>在设置速度的情况下，元素在切换的过程中，会逐渐地改变其高度（这样会创造滑动效果）。</p>
</td>
</tr>
...
<dl>
<dt><a href="../tiy/t.asp@f=jquery_effect_slidetoggle_speed">使用 speed 参数</a></dt>
<dd>使用 speed 参数来切换上下滑动地显示和隐藏元素。</dd>
</dl>
</div>
