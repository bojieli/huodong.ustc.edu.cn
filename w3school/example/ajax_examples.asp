...
<h2>AJAX 实例</h2>
<ul>
<li><a href="ajax_examples.asp" title="AJAX 实例">AJAX 实例</a></li>
</ul>
...
<li class="pre"><a href="../ajax/ajax_xmlfile.asp">Previous Page</a></li>

<li class="next"><a href="../ajax/index.asp">Next Page</a></li>
</ul>
