...
<p>该方法将删除规则数组的指定 <i>index</i> 处的 CSS 样式规则。它是标准的 <a href="met_cssstylesheet_deleterule.asp">deleteRule() 方法</a>的一个特定于 IE 的替代方法。</p>
...
<p>XML DOM 参考手册：<a href="met_cssstylesheet_deleterule.asp">CSSStyleSheet.deleteRule()</a></p>
</div>
