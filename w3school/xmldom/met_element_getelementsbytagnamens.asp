...
<h3>说明</h3>
<p>该方法与 <a href="met_element_getelementsbytagname.asp" title="XML DOM getElementsByTagName() 方法">getElementsByTagName() 方法</a>相似，只是想获取的元素的标记名被指定为命名空间 URI 和在命名空间中定义的本地名的组合。只有使用命名空间的 XML 文档才使用该方法。</p>
</div>
