...
<li class="pre"><a href="dom_xmlserializer.asp">Previous Page</a></li>

<li class="next"><a href="dom_xpathresult.asp">Next Page</a></li>
</ul>
...
<div>
<p>XPathExpression 对象是一个 XPath 查询的编译过的表现形式，由 <a href="met_document_createexpression.asp" title="XML DOM createExpression() 方法">Document.createExpression()</a> 返回。使用 evaluate() 方法根据一个特定的文档节点来计算该表达式。如果你需要仅计算一个 XPath 查询一次，可以使用 <a href="met_document_evaluate.asp" title="XML DOM evaluate() 方法">Document.evaluate()</a>，它在一个步骤里编译并计算表达式。</p>
<p>IE 不支持 XPathExpression 对象。</p>
<p>请参阅：<a href="met_node_selectnodes.asp" title="XML DOM selectNodes() 方法">Node.selectNodes()</a> 和 <a href="met_node_selectsinglenode.asp" title="XML DOM selectSingleNode() 方法">Node.selectSingleNode()</a>，了解特定于 IE 的 XPath 方法。</p>
</div>
...
<p><i>type</i> 参数是期待的结果类型。这个参数应该是 <a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult</a> 定义的一个常量。</p>
<p><i>result</i> 参数是一个 <a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult 对象</a>，查询结果存储于其中。如果要让 evaluate() 方法创建并返回一个新的 <a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult 对象</a>，则为 null。</p>

<h3>返回值</h3>
<p>保存查询结果的一个 <a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult</a>。要么是作为 <i>result</i> 参数传递的对象，或者是 <i>result</i> 为 null 而新创建的一个 <a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult 对象</a>。</p>

<h3>说明</h3>
<p>这个方法根据指定的节点或文档来计算 XPathExpression，并把结果返回到一个 <a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult 对象</a>。</p>
<p>参阅 <a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult</a>，了解如何从返回对象中提取值。</p>
</div>
