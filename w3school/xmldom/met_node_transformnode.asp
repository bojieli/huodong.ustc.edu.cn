...
<p>这个 transformNode() 方法只在 XML 文档节点上存在，在 HTML 文档中不存在。注意，既然 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>是它们自己的节点，这个方法可以应用于整个 XML 文档。</p>
<p>参阅 <a href="dom_xsltprocessor.asp" title="XML DOM XSLTProcessor 对象">XSLTProcessor</a>，了解其他浏览器中的相似功能。</p>

<h3>参阅</h3>
<p><a href="met_node_transformnodetoobject.asp" title="XML DOM transformNodeToObject() 方法">Node.transformNodeToObject()</a></p>
</div>
