...
<h3>说明</h3>
<p>这个特定于 IE 的方法计算一个 XPath 表达式，使用该节点作为查询的根节点，并且将结果作为一个 NodeList 返回。这个 selectNodes() 方法只用于 XML 文档节点，不用于 HTML 文档节点。注意，既然 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>是它们自己的节点，这个方法可以应用于整个 XML 文档。</p>

<p>参阅 <a href="met_document_evaluate.asp" title="XML DOM evaluate() 方法">Document.evaluate()</a>，了解一个跨浏览器的替代方法。</p>

<h3>参阅</h3>
<p><a href="met_document_createexpression.asp" title="XML DOM createExpression() 方法">Document.createExpression()</a></p>
</div>
