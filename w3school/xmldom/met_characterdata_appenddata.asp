...
<p><a href="dom_characterdata.asp" title="XML DOM CharacterData 对象">CharacterData 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>
<p>appendData() 方法把字符串附加到 <a href="dom_text.asp">Text</a> 或 <a href="met_text_appenddata.asp">Comment</a> 节点上。</p>
...
<p>如果调用该方法的节点是只读的，它将抛出具有代码为 NO_MODIFICATION_ALLOWED_ERR 的 <a href="dom_domexception.asp">DOMException 异常</a>。</p>
...
<p>XML DOM 参考手册：<a href="met_text_appenddata.asp">Text.appendData()</a></p>
<p>XML DOM 参考手册：<a href="met_comment_appenddata.asp">Comment.appendData()</a></p>
</div>
