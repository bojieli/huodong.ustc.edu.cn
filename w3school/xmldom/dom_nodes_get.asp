...
<li class="pre"><a href="dom_nodes_navigate.asp">Previous Page</a></li>

<li class="next"><a href="dom_nodes_set.asp">Next Page</a></li>
</ul>
...
<p>下面的代码通过使用 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;<a href="../example/xdom/books.xml">books.xml</a>&quot; 载入 xmlDoc 中，并检索第一个 &lt;title&gt; 元素：</p>
