...
<div>
<h2>定义和用法</h2>
<p>insertData() 方法把字符串插入 <a href="dom_text.asp">Text</a> 或 <a href="met_text_appenddata.asp">Comment</a> 节点。</p>
...
<p>XML DOM 参考手册：<a href="met_text_insertdata.asp">Text.insertData()</a></p>
<p>XML DOM 参考手册：<a href="met_comment_insertdata.asp">Comment.insertData()</a></p>
</div>
