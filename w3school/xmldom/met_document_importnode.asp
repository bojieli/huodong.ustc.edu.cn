...
<h3>抛出</h3>
<p>如果 <i>importedNode</i> 是 Document 节点或 DocumentType 节点，该方法将抛出代码为 NOT_SUPPORTED_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>，因为不能导入这些类型的节点。</p>
...
<div>
<h2>参阅</h2>
<p><a href="met_node_clonenode.asp" title="XML DOM cloneNode() 方法">Node.cloneNode()</a></p>
</div>
