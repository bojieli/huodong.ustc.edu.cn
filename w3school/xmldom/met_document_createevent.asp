...
<div>
<h2>定义和用法</h2>
<p>createEvent() 方法创建新的 <a href="dom_event.asp" title="XML DOM Event 对象">Event 对象</a>。</p>
...
<p>关于有效的事件类型列表，请参阅“<a href="met_document_createevent.asp#eventType">说明</a>”部分。</p></td>
</tr>
</table>

<h3>返回值</h3>
<p>返回新创建的 <a href="dom_event.asp" title="XML DOM Event 对象">Event 对象</a>，具有指定的类型。</p>

<h3>抛出</h3>
<p>如果实现支持需要的事件类型，该方法将抛出代码为 NOT_SUPPORTED_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
...
<p>用该方法创建了 Event 对象以后，必须用上表中所示的初始化方法初始化对象。关于初始化方法的详细信息，请参阅 <a href="dom_event.asp" title="XML DOM Event 对象">Event 对象参考</a>。</p>
<p>该方法实际上不是由 Document 接口定义的，而是由 DocumentEvent 接口定义的。如果一个实现支持 Event 模块，那么 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>就会实现 DocumentEvent 接口并支持该方法。</p>
</div>
