...
<p><a href="dom_text.asp" title="XML DOM - Text 对象">Text 对象参考手册</a></p>
</div>
...
<p><a href="dom_cdatasection.asp" title="XML DOM CDATASection 对象">CDATASection 接口</a>继承了 Text 接口，CDATASection 节点也可以使用该方法 ，只是新创建的节点是 CDATASection 节点，而不是 Text 节点。</p>
</div>
