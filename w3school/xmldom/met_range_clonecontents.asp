...
<div>
<h2>定义和用法</h2>
<p>cloneContents() 方法把范围（Range）的内容复制到一个 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 对象</a>。</p>

<h3>语法：</h3>
<pre>extractContents()</pre>

<h3>返回值</h3>
<p>一个 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 节点</a>，包含该范围中的文档内容的副本。</p>
...
<h3>描述</h3>
<p>该方法将复制当前范围的内容，把它存放在一个 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 对象</a>中，返回该对象。</p>
</div>
