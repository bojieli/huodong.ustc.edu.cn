...
<p>该方法与 <a href="met_element_getattributenode.asp" title="XML DOM getAttributeNode() 方法">getAttributeNode() 方法</a>类似，只是属性名由命名空间 URI 和在这个命名空间中定义的本地名共同指定。只有使用命名空间的 XML 文档才使用该方法。</p>
</div>

<div>
<h2>实例</h2>

<p>在所有的例子中，我们将使用 XML 文件 <a href="../example/xdom/books_ns.xml">books_ns.xml</a>，以及 JavaScript 函数 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a>。</p>
...
<h2>TIY</h2>
<dl>
<dt><a href="http://www.w3school.com.cn/tiy/t.asp?f=xdom_element_getattributenode">获取属性的值</a></dt>
