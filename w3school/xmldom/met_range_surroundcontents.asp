...
<h3>抛出</h3>
<p>该方法将在下列情况下抛出具有如下代码的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>或 <a href="dom_rangeexception.asp" title="XML DOM - RangeException 对象">RangeException 异常</a>：</p>
