...
<li class="pre"><a href="dom_nodetype.asp">Previous Page</a></li>

<li class="next"><a href="dom_cdatasection.asp">Next Page</a></li>
</ul>
...
<tr>
	<td><a href="prop_attr_baseuri.asp" title="XML DOM baseURI 属性">baseURI</a></td>
	<td>返回属性的绝对基准 URI。</td>
	<td>No</td>
	<td>1</td>
	<td>No</td>
...
<tr>
	<td><a href="prop_attr_isid.asp" title="XML DOM isId 属性">isId</a></td>
...
<tr>
	<td><a href="prop_attr_localname.asp" title="XML DOM localName 属性">localName</a></td>
	<td>返回属性名称的本地部分。</td>
	<td>No</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_attr_name.asp" title="XML DOM name 属性">name</a></td>
	<td>返回属性的名称。</td>
	<td>5</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_attr_namespaceuri.asp" title="XML DOM namespaceURI 属性">namespaceURI</a></td>
	<td>返回属性的命名空间 URI。</td>
	<td>No</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_attr_nodename.asp" title="XML DOM nodeName 属性">nodeName</a></td>
	<td>返回节点的名称，依据其类型。</td>
	<td>5</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_attr_nodetype.asp" title="XML DOM nodeType 属性">nodeType</a></td>
	<td>返回节点的类型。</td>
	<td>5</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_attr_nodevalue.asp" title="XML DOM nodeValue 属性">nodeValue</a></td>
...
<tr>
	<td><a href="prop_attr_ownerdocument.asp" title="XML DOM ownerDocument 属性">ownerDocument</a></td>
...
<tr>
	<td><a href="prop_attr_ownerelement.asp" title="XML DOM ownerElement 属性">ownerElement</a></td>
	<td>返回属性所附属的元素节点。</td>
	<td>No</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_attr_prefix.asp" title="XML DOM prefix 属性">prefix</a></td>
...
<tr>
	<td><a href="prop_attr_specified.asp" title="XML DOM specified 属性">specified</a></td>
...
<tr>
	<td><a href="prop_attr_textcontent.asp" title="XML DOM textContent 属性">textContent</a></td>
	<td>设置或返回属性的文本内容。</td>
	<td>No</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_attr_text.asp" title="XML DOM text 属性">text</a></td>
...
<tr>
	<td><a href="prop_attr_value.asp" title="XML DOM value 属性">value</a></td>
	<td>设置或返回属性的值。</td>
	<td>5</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_attr_xml.asp" title="XML DOM xml 属性">xml</a></td>
