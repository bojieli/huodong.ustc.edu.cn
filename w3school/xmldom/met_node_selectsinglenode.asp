...
<p>这个 selectSingleNode() 方法只在 XML 文档节点上存在，在 HTML 文档中不存在。注意，既然 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>是它们自己的节点，这个方法可以应用于整个 XML 文档。</p>
