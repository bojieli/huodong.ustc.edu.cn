...
<p><a href="dom_domimplementation.asp" title="XML DOM - DomImplementation 对象">DomImplementation 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>createDocument() 方法创建一个新 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>和指定的根元素。</p>
...
<h3>返回值</h3>
<p>一个带有 documentElement 属性的 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>，设置为指定类型的 Element 根节点。</p>

<h3>说明</h3>
<p>该方法创建一个新的 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>，并为文档指定它的根对象 documentElement。如果参数 <i>doctype</i> 不是 null，那么 DocumentType 对象的 ownerDocument 属性将被设置为新创建的文档。</p>
<p>该方法用于创建 XML 文档，只支持 HTML 的实现可能不支持它。</p>


<h3>参阅</h3>
<p><a href="met_domimplementation_createdocumenttype.asp" title="XML DOM createDocumentType() 方法">DomImplementation.createDocumentType()</a></p>
</div>
