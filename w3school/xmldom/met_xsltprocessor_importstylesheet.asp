...
<h3>说明</h3>
<p>importStylesheet() 指定了将来调用 <a href="met_xsltprocessor_transformtodocument.asp" title="XML DOM transformToDocument() 方法">transformToDocument()</a> 和 <a href="met_xsltprocessor_transformtofragment.asp" title="XML DOM transformToFragment() 方法">transformToFragment()</a> 要用到的 XSLT 样式表。</p>
</div>
