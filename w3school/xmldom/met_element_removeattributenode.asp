...
<h3>说明</h3>
<p>该方法从当前元素的属性集合中删除（并返回）一个 Attr 节点。如果 DTD 给删除的属性设置了默认值，那么该方法将添加一个新的 Attr 节点，表示这个默认值。用 <a href="met_element_removeattribute.asp" title="XML DOM removeAttribute() 方法">removeAttribute() 方法</a>代替该方法往往会更简单。</p>
</div>
