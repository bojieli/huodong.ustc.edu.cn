...
<li class="next"><a href="dom_loadxmldoc.asp">Next Page</a></li>
</ul>
...
<p class="note"><span>注释：</span>Internet Explorer 使用 loadXML() 方法来解析 XML 字符串，而其他浏览器使用 <a href="dom_domparser.asp" title="XML DOM - DOMParser 对象">DOMParser 对象</a>。</p>
</div>
