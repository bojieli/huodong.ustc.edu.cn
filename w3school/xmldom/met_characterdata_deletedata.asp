...
<div>
<h2>定义和用法</h2>
<p>deleteData() 方法从 <a href="dom_text.asp">Text</a> 或 <a href="met_text_appenddata.asp">Comment</a> 节点删除文本。</p>
...
<p>XML DOM 参考手册：<a href="met_text_deletedata.asp">Text.deleteData()</a></p>
<p>XML DOM 参考手册：<a href="met_comment_deletedata.asp">Comment.deleteData()</a></p>
</div>
