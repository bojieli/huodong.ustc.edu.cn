...
<li class="pre"><a href="dom_domexception.asp">Previous Page</a></li>

<li class="next"><a href="dom_domparser.asp">Next Page</a></li>
</ul>
...
<p>DomImplementation 接口是一个占位符，存放不专属任何特定 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>，而对 DOM 实现来说是“全局性”的方法。可以通过任何 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>的 implementation 属性获得对 DomImplementation 对象的引用。</p>
