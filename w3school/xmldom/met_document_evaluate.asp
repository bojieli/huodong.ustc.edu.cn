...
<div>
<p><a href="dom_document.asp">Document 对象参考手册</a></p>
</div>
...
<h3>返回值</h3>
<p>表示根据给定的 Context 节点计算的表达式的一个 <a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult 对象</a>。</p>
...
<p>该方法根据给定的 Context 节点来计算指定的 XPath 表达式，并且返回一个 XPathResult 对象，该对象是 type 来确定结果类型应该是什么。如果你想多次计算一个表达式，使用 <a href="met_document_createexpression.asp" title="XML DOM createExpression() 方法">Document.createExpression()</a> 来把表达式编译成一个 <a href="dom_xpathexpression.asp" title="XML DOM - XPathExpression 对象">XPathExpression 对象</a>，然后使用 XPathExpression 的 evaluate() 方法。</p>

<p>IE 不支持这个 API。参阅 <a href="met_node_selectnodes.asp" title="XML DOM selectNodes() 方法">Node.selectNodes()</a> 和 <a href="met_node_selectsinglenode.asp" title="XML DOM selectSingleNode() 方法">Node.selectSingleNode()</a> 来了解一个特定于 IE 的替代方法。</p>
</div>

<div>
<h2>参阅</h2>
<ul>
<li><a href="met_document_createexpression.asp" title="XML DOM createExpression() 方法">Document.createExpression()</a></li>
<li><a href="met_node_selectnodes.asp" title="XML DOM selectNodes() 方法">Node.selectNodes()</a></li>
<li><a href="met_node_selectsinglenode.asp" title="XML DOM selectSingleNode() 方法">Node.selectSingleNode()</a></li>
<li><a href="dom_xpathexpression.asp" title="XML DOM - XPathExpression 对象">XPathExpression</a></li>
<li><a href="dom_xpathresult.asp" title="XML DOM XPathResult 对象">XPathResult</a></li>
</ul>
</div>
