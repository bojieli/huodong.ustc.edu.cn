...
<p><a href="dom_comment.asp" title="XML DOM - Comment 对象">Comment 对象参考手册</a></p>
</div>
...
<p>以下代码段使用 JavaScript 函数 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 XML 文件 <a href="../example/xdom/books_comment.xml">books_comment.xml</a> 载入 xmlDoc 中，然后用 &quot;Paperback&quot; 替换第一个 &lt;book&gt; 元素的注释节点中的 &quot;Hardcover&quot;：</p>
...
<p>XML DOM 参考手册：<a href="met_characterdata_replacedata.asp">CharacterData.replaceData()</a></p>
</div>
