...
<li class="pre"><a href="dom_mozilla_vs_ie.asp">Previous Page</a></li>

<li class="next"><a href="dom_nodes_get.asp">Next Page</a></li>
</ul>
...
<ul>
<li>通过使用 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;<a href="../example/xdom/books.xml">books.xml</a>&quot; 载入到 xmlDoc 中</li>
<li>获取第一个 &lt;book&gt; 元素</li>
<li>输出 &quot;x&quot; 的父节点的节点名</li>
</ul>
