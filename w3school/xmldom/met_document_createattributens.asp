...
<h3>说明</h3>
<p>createAttributeNS() 方法与 <a href="met_document_createattribute.asp" title="XML DOM createAttribute() 方法">createAttribute() 方法</a>相似，只是它创建的 Attr 节点除了具有指定的名称外，还具有指定的命名空间。只有使用命名空间的 XML 文档才会使用该方法。</p>
</div>
