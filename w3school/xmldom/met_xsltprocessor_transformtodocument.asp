...
<h3>返回值</h3>
<p>保存了转换结果的一个 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>。</p>


<h3>说明</h3>
<p>这个方法在一个指定的节点上执行一次 XSLT 转换，结果作为一个 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>返回。</p>
<p>转换使用 <a href="met_xsltprocessor_importstylesheet.asp" title="XML DOM importStylesheet() 方法">importStylesheet()</a> 指定的 XSLT 样式表和 <a href="met_xsltprocessor_setparameter.asp" title="XML DOM setParameter() 方法">setParameter()</a> 指定的参数值。</p>
</div>
