...
<div>
<p><a href="dom_documenttype.asp">DocumentType 对象参考手册</a></p>
</div>
...
<p>在所有的例子中，我们将使用 XML 文件 <a href="../example/xdom/note_internal_dtd.xml">note_internal_dtd.xml</a>，以及 JavaScript 函数 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a>。</p>
