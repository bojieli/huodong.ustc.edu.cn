...
<h3>抛出</h3>
<p>如果当前范围表示的部分文档是只读的，该方法将抛出代码为 NO_MODIFICATION_ALLOWED_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>

<h3>描述</h3>
<p>该方法将删除当前范围表示的所有文档内容。当该方法返回时，当前范围的边界点将重合。</p>
<p class="important"><span>注意：</span>这种删除操作可以生成相邻的 Text 节点，调用 <a href="met_node_normalize.asp" title="XML DOM normalize() 方法">Node.normalize()</a> 方法可以合并这些节点。</p>

<h3>参阅</h3>
<p>关于复制文档内容的方法，请参阅 <a href="met_range_clonecontents.asp" title="XML DOM cloneContents() 方法">Range.cloneContents()</a>。</p>
<p>关于进行文档内容的复制和删除操作的方法，请参阅 <a href="met_range_extractcontents.asp" title="XML DOM extractContents() 方法">Range.extractContents()</a>。</p>
</div>
