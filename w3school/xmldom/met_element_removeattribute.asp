...
<p>removeAttribute() 方法删除指定的属性。如果文档类型声明 (DTD) 为指定的属性设置了默认值，那么接下来调用 <a href="met_element_getattribute.asp" title="XML DOM getAttribute() 方法">getAttribute() 方法</a>将返回那个默认值。</p>
