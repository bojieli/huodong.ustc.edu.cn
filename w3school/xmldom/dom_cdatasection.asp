...
<li class="pre"><a href="dom_attribute.asp">Previous Page</a></li>

<li class="next"><a href="dom_characterdata.asp">Next Page</a></li>
</ul>
...
<p>CDATASection 接口是 <a href="dom_text.asp" title="XML DOM Text 对象">Text</a> 接口的子接口，没有定义任何自己的属性和方法。通过从 <a href="dom_node.asp" title="XML DOM Node 对象">Node</a> 接口继承 <a href="prop_node_nodevalue.asp" title="XML DOM nodeValue 属性">nodeValue</a> 属性，或通过从 <a href="dom_characterdata.asp" title="XML DOM CharacterData 对象">CharacterData</a> 接口继承 data 属性，可以访问 CDATA Section 的文本内容。</p>

<p>虽然通常可以把 CDATASection 节点作为 <a href="dom_text.asp" title="XML DOM - Text 对象">Text</a> 节点处理，但要注意，<a href="met_node_normalize.asp" title="XML DOM normalize() 方法
">Node.normalize()</a> 方法不并入相邻的 CDATA 部分。</p>

<p>使用 <a href="met_document_createcdatasection.asp" title="XML DOM createCDATASection() 方法">Document.createCDATASection()</a> 来创建一个 CDATASection。</p>
