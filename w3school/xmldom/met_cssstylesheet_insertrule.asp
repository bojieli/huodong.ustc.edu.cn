...
<p><a href="dom_cssstylesheet.asp" title="XML DOM CSSStyleSheet 对象">CSSStyleSheet 对象参考手册</a></p>
</div>
...
<p>该方法在下列情况下将抛出具有以下代码的 <a href="dom_domexception.asp">DOMException 异常</a>：</p>
...
<p>该方法将在样式表的 cssRules 数组的指定 <i>index</i> 处插入（或附加）新的 CSS rule。这是一个 DOM 标准方法，请参阅 <a href="met_cssstylesheet_addrule.asp">CSSStyleSheet.addRule()</a>，它是特定于 IE 的一个替代方法。</p>
...
<p>XML DOM 参考手册：<a href="met_cssstylesheet_addrule.asp">CSSStyleSheet.addRule()</a></p>
</div>
