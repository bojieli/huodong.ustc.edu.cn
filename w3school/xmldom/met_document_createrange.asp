...
<div>
<h2>定义和用法</h2>
<p>createRange() 方法创建 <a href="dom_range.asp" title="XML DOM - Range 对象">Range 对象</a>。</p>

<h3>语法：</h3>
<pre>createRange()</pre>

<h3>返回值</h3>
<p>返回新创建的 <a href="dom_range.asp" title="XML DOM - Range 对象">Range 对象</a>，两个边界点都被设置为文档的开头。</p>

<h3>描述</h3>
<p>该方法将创建一个 <a href="dom_range.asp" title="XML DOM - Range 对象">Range 对象</a>，可以用来表示文档的一个区域或与该文档相关的 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 对象</a>。</p>
<p>注意，该方法实际上不是由 Document 接口定义的，而是由 DocumentRange 接口定义的。如果一个实现支持 Range 模块，那么 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>就会实现 DocumentRange 接口，并定义该方法。IE 6 不支持这个模块。</p>
</div>
