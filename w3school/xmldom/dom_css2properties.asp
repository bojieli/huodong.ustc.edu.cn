...
<li class="pre"><a href="dom_characterdata.asp">Previous Page</a></li>

<li class="next"><a href="dom_cssrule.asp">Next Page</a></li>
</ul>
...
<p>将这一属性设置为非法的值将会抛出一个代码为 SYNTAX_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。当 CSS2Properties 对象是只读的时候，试图设置这一属性将会抛出一个代码为 NO_MODIFICATION_ALLOWED_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
...
<p>和 CSS2 规范所定义的每个属性相对应的 CSS2Properties 属性名在 <a href="../htmldom/dom_obj_style.asp" title="HTML DOM Style 对象">style 对象参考手册</a>中列出。请注意，有些浏览器并不支持所有的 CSS 属性，因而也可能并不支持列出的所有属性。由于这些属性直接对应于 CSS 属性，您也可以参考 W3School 提供的 <a href="../css/css_reference.asp">CSS 参考手册</a>，来查看它们的含义和合法值。</p>
</div>

<div>
<h2>相关页面</h2>
<p>HTML DOM 参考手册：<a href="../htmldom/dom_obj_style.asp" title="HTML DOM Style 对象">Style 对象</a></p>
