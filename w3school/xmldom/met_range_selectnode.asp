...
<h3>抛出</h3>
<p>如果 <i>refNode</i> 是 Attr、Document、或 Notation 节点，该方法将抛出代码为 INVALID_NODE_TYPE_ERR 的 <a href="dom_rangeexception.asp" title="XML DOM - RangeException 对象">RangeException 异常</a>。</p>
...
<h3>参阅</h3>
<p><a href="met_range_selectnodecontents.asp" title="XML DOM selectNodeContents() 方法">Range.selectNodeContents()</a>。</p>
</div>
