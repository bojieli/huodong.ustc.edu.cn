...
<li class="pre"><a href="dom_cssstylesheet.asp">Previous Page</a></li>

<li class="next"><a href="dom_document.asp">Next Page</a></li>
</ul>
...
<p>在下面的例子中，我们会使用 XML 文件 <a href="../example/xdom/books_comment.xml">books_comment.xml</a>，以及 JavaScript 函数 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a>。</p>
...
<p>使用由 <a href="dom_characterdata.asp">CharacterData 接口</a>继承的 <a href="prop_comment_data.asp" title="XML DOM data 属性">data 属性</a>，或使用由 Node 接口继承的 <a href="prop_node_nodevalue.asp" title="XML DOM nodeValue 属性">nodeValue 属性</a>，可以访问注释的内容。（即 &lt;!-- 和 --&gt; 之间的文本）。使用由 CharacterData 接口继承的各种方法可以操作注释的内容。</p>

<p>使用 <a href="met_document_createcomment.asp" title="XML DOM createComment() 方法">Document.createComment()</a> 来创建一个注释对象。</p>
</div>
...
<tr>
	<td><a href="prop_comment_data.asp" title="XML DOM data 属性">data</a></td>
	<td>可设置或返回此节点的文本。</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="prop_comment_length.asp" title="XML DOM length 属性">length</a></td>
	<td>可返回此节点的文本的长度。</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="met_comment_appenddata.asp" title="XML DOM appendData() 方法">appendData()</a></td>
	<td>向节点追加数据。</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="met_comment_deletedata.asp" title="XML DOM deleteData() 方法">deleteData()</a></td>
	<td>从节点删除数据。</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="met_comment_insertdata.asp" title="XML DOM insertData() 方法">insertData()</a></td>
	<td>向节点中插入数据。</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="met_comment_replacedata.asp" title="XML DOM replaceData() 方法">replaceData()</a></td>
	<td>替换节点中的数据。</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="met_comment_substringdata.asp" title="XML DOM substringData() 方法">substringData()</a></td>
	<td>从节点中提取数据。</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
