...
<li class="pre"><a href="dom_cssstylerule.asp">Previous Page</a></li>

<li class="next"><a href="dom_comment.asp">Next Page</a></li>
</ul>
...
<tr>
	<td><a href="met_cssstylesheet_addrule.asp">addRule()</a></td>
	<td>为一个样式表添加一条规则的特定于 IE 的方法。</td>
</tr>
<tr>
	<td><a href="met_cssstylesheet_deleterule.asp">deleteRule()</a></td>
	<td>从指定位置删除规则的 DOM 标准方法。</td>
</tr>
<tr>
	<td><a href="met_cssstylesheet_insertrule.asp">insertRule()</a></td>
	<td>向样式表中插入一条新规则的 DOM 标准方法。</td>
</tr>
<tr>
	<td><a href="met_cssstylesheet_removerule.asp">removeRule()</a></td>
...
<div>
<h2>相关页面</h2>
<p>XML DOM 参考手册：<a href="dom_cssrule.asp" title="XML DOM CSSRule 对象">CSSRule 对象</a></p>
</div>
