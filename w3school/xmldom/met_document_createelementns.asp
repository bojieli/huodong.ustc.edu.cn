...
<h3>说明</h3>
<p>createElementNS() 方法与 <a href="met_document_createelement.asp" title="XML DOM createElement() 方法">createElement() 方法</a>相似，只是它创建的 Element 节点除了具有指定的名称外，还具有指定的命名空间。只有使用命名空间的 XML 文档才会使用该方法。</p>
</div>
