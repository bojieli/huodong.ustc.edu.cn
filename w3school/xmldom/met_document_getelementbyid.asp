...
<p>在 HTML 文档中，该方法总是检索具有指定 id 的属性。可以使用 <a href="../htmldom/met_doc_getelementsbyname.asp" title="HTML DOM getElementsByName() 方法">HTMLDocument.getElementByName() 方法</a>，根据它们的 name 属性中的值来查找 HTML 元素。</p>
...
<div>
<h2>参阅</h2>
<p><a href="met_document_getelementsbytagname.asp" title="XML DOM getElementsByTagName() 方法">Document.getElementsByTagName()</a></p>
<p><a href="met_element_getelementsbytagname.asp" title="XML DOM getElementsByTagName() 方法">Element.getElementsByTagName()</a></p>
<p><a href="../htmldom/met_doc_getelementsbyname.asp" title="HTML DOM getElementsByName() 方法">HTMLDocument.getElementByName()</a></p>
</div>
