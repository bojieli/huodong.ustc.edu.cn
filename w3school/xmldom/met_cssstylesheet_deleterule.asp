...
<p>该方法将删除 cssRules 数组指定 <i>index</i> 处的规则，它是 DOM 标准方法。请参阅 <a href="met_cssstylesheet_addrule.asp">CSSStyleSheet.addRule()</a>，它是特定于 IE 的一个替代方法。</p>
...
<p>XML DOM 参考手册：<a href="met_cssstylesheet_removerule.asp">CSSStyleSheet.removeRule()</a></p>
</div>
