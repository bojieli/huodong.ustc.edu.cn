...
<li class="pre"><a href="dom_cdatasection.asp">Previous Page</a></li>

<li class="next"><a href="dom_css2properties.asp">Next Page</a></li>
</ul>
...
<p>CharacterData 是 <a href="dom_text.asp">Text</a> 和 <a href="met_text_appenddata.asp">Comment</a> 节点的超接口。文档从不包含 CharacterData 节点，它们只包含 Text 节点和 Comment 节点。但由于这两种节点具有相似的功能，因此此处定义了这些函数，以便 Text 和 Comment 可以继承它。</p>
...
<tr>
	<td><a href="met_characterdata_appenddata.asp">appendData()</a></td>
...
<tr>
	<td><a href="met_characterdata_deletedata.asp">deleteData()</a></td>
	<td>从该节点删除指定的文本。</td>
	<td>6</td>
	<td>1</td>
	<td>9</td>
...
<tr>
	<td><a href="met_characterdata_insertdata.asp">insertData()</a></td>
...
<tr>
	<td><a href="met_characterdata_replacedata.asp">replaceData()</a></td>
...
<tr>
	<td><a href="met_characterdata_substringdata.asp">substringData()</a></td>
...
<p>XML DOM 参考手册：<a href="dom_comment.asp">Comment 对象</a></p>
<p>XML DOM 参考手册：<a href="dom_text.asp">Text 对象</a></p>
</div>
