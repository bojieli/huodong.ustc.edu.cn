...
<h3>返回值</h3>
<p>返回新创建的 <a href="dom_range.asp" title="XML DOM - Range 对象">Range 对象</a>。</p>
</div>


<div>
<h2>参阅</h2>
<p><a href="met_document_createrange.asp" title="XML DOM createRange() 方法">Document.createRange()</a></p>
</div>
