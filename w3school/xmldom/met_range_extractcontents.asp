...
<div>
<h2>定义和用法</h2>
<p>extractContents() 方法删除文档内容，并以 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 对象</a>的形式返回它。</p>

<h3>语法：</h3>
<pre>extractContents()</pre>

<h3>返回值</h3>
<p>一个 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 节点</a>，包含该范围的内容。</p>

<h3>抛出</h3>
<p>如果要提取的文档内容是只读的，该方法将抛出代码为 NO_MODIFICATION_ALLOWED_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
<p>如果当前范围包括 <a href="dom_documenttype.asp" title="XML DOM - DocumentType 对象">DocumentType 节点</a>，该方法将抛出代码为 HIERARCHY_REQUEST_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>

<h3>描述</h3>
<p>该方法将删除文档的指定范围，并返回包含被删除内容（或被删除的内容的副本）的 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 节点</a>。当返回该方法时，范围将折叠，文档中可能出现相邻的 Text 节点（用 <a href="met_node_normalize.asp" title="XML DOM normalize() 方法">Node.normalize()</a> 可以合并）。</p>
</div>
