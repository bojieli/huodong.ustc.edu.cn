...
<li class="pre"><a href="dom_nodes_remove.asp">Previous Page</a></li>

<li class="next"><a href="dom_nodes_create.asp">Next Page</a></li>
</ul>
...
<p>您可以在 <a href="dom_nodes_set.asp" title="XML DOM 改变节点值">改变节点</a> 这一节中阅读更多有关更改节点值的内容。</p>
</div>
