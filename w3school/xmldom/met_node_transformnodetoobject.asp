...
<div>
<p><a href="dom_node.asp">Node 对象参考手册</a></p>
</div>
...
<tr>
<td>query</td>
<td>一个 XSLT 样式表，解析为一个 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>。</td>
</tr>
</table>

<h3>返回值</h3>
<p>转换的结果，解析为一个 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>。</p>

<h3>说明</h3>
<p>这个特定于 IE 的方法根据一个 XSLT 样式表指定的规则来转换一个 Node 及其子孙，并将结果作为一个 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>返回。</p>
<p>这个 transformNode() 方法只在 XML 文档节点上存在，HTML 文档不存在该方法。注意，既然 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>是它们自己的节点，这个方法可以应用于整个 XML 文档。</p>
<p>参阅 <a href="dom_xsltprocessor.asp" title="XML DOM XSLTProcessor 对象">XSLTProcessor</a>，了解其他浏览器中的相似功能。</p>

<h3>参阅</h3>
<p><a href="met_node_transformnode.asp" title="XML DOM transformNode() 方法">Node.transformNode()</a></p>
</div>
