...
<li class="pre"><a href="dom_http.asp">Previous Page</a></li>

<li class="next"><a href="dom_xpathexpression.asp">Next Page</a></li>
</ul>
...
<p>参阅：<a href="prop_node_xml.asp" title="XML DOM xml 属性">Node.xml</a></p>
</div>
...
<p>node 参数是要序列化的 XML 节点。这可能是文档中一个 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>或者任何 Element。</p>
