...
<li class="pre"><a href="dom_nodes_info.asp">Previous Page</a></li>

<li class="next"><a href="dom_nodes_traverse.asp">Next Page</a></li>
</ul>
...
<p>下面的代码片段通过使用 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;books.xml&quot; 载入 xmlDoc 中，并返回 &quot;<a href="../example/xdom/books.xml">books.xml</a>&quot; 中 title 元素的一个节点列表：</p>
...
<p>下面的代码片段通过使用 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;<a href="../example/xdom/books.xml">books.xml</a>&quot; 载入 xmlDoc，并返回 &quot;books.xml&quot; 中 &lt;title&gt; 元素的数量：</p>
...
<ul>
<li>通过使用 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;<a href="../example/xdom/books.xml">books.xml</a>&quot; 载入 xmlDoc</li>
...
<p>下面的代码片段通过使用 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 &quot;books.xml&quot; 载入 xmlDoc 中，并从 &quot;<a href="../example/xdom/books.xml">books.xml</a>&quot; 中的第一个 &lt;book&gt; 元素返回属性节点的一个列表：</p>
