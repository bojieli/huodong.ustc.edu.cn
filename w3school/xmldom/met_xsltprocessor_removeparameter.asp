...
<h3>说明</h3>
<p>removeParameter() 删除指定的参数的值，如果这个参数之前用 <a href="met_xsltprocessor_setparameter.asp" title="XML DOM setParameter() 方法">setParameter()</a> 设置过的话。后续的转换使用样式表中指定的这个参数的默认值。</p>
</div>
