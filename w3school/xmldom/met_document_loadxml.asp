...
<p>这个方法在表示 HTML 文档的 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>上并不存在。在调用 loadXML() 之前，通常创建一个新的、空的 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>来保存解析的内容：</p>

<pre>var doc = new ActivexObject (&quot;MSXML2.DOMDocument&quot;);
doc.loadXML(markup);</pre>

<p>参阅 <a href="dom_domparser.asp#parseFromString" title="DOMParser.parseFromString()">DOMParser.parseFromString()</a> 以了解一种非 IE 的替代方法。</p>
</div>

<div>
<h2>参阅</h2>
<p><a href="dom_domparser.asp#parseFromString" title="DOMParser.parseFromString()">DOMParser.parseFromString()</a></p>
</div>
