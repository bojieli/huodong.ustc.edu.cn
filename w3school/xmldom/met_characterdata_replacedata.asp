...
<div>
<h2>定义和用法</h2>
<p>replaceData() 方法用指定的字符串替换 <a href="dom_text.asp">Text</a> 或 <a href="met_text_appenddata.asp">Comment</a> 节点的字符。</p>
...
<p>该方法可以抛出具有以下代码的 <a href="dom_domexception.asp">DOMException 异常</a>：</p>
...
<p>XML DOM 参考手册：<a href="met_text_replacedata.asp">Text.replaceData()</a></p>
<p>XML DOM 参考手册：<a href="met_comment_replacedata.asp">Comment.replaceData()</a></p>
</div>
