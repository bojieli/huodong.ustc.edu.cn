...
<li class="pre"><a href="dom_documenttype.asp">Previous Page</a></li>

<li class="next"><a href="dom_domimplementation.asp">Next Page</a></li>
</ul>
...
<p>下面的常量定义了 DOMException 对象的 <a href="dom_domexception.asp#property_code">code</a> 属性的合法值。</p>
