...
<h3>抛出</h3>
<p>如果该文档是 HTML 文档，该方法将抛出代码为 NOT_SUPPORTED_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>，因为 HTML 文档不支持 CDATASection 节点。</p>
</div>
