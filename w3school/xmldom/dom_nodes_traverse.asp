...
<li class="pre"><a href="dom_nodes_nodelist.asp">Previous Page</a></li>

<li class="next"><a href="dom_mozilla_vs_ie.asp">Next Page</a></li>
</ul>
...
<p>函数 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLString()</a>，位于外部 JavaScript 中，用于加载 XML 文件。</p>
...
<ul>
<li><a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLString()</a> 把 XML 字符串载入 xmlDoc 中</li>
<li>获取根元素的子节点</li>
