...
<p><a href="dom_event.asp" title="XML DOM Event 对象">Event 对象参考手册</a></p>
</div>
...
<p>
该方法将初始化 <a href="met_document_createevent.asp" title="XML DOM createEvent() 方法">Document.createEvent() 方法</a> 创建的合成 Event 对象的 type 属性、bubbles 属性和 cancelable 属性。

只有在新创建的 Event 对象被 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a> 或 <a href="dom_element.asp" title="XML DOM - Element 对象">Element 对象</a> 的 <a href="met_element_dispatchevent.asp" title="XML DOM dispatchEvent() 方法">dispatchEvent() 方法</a> 分派之前，才能调用 Event.initEvent() 方法。
</p>
</div>
