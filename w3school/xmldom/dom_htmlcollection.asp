...
<li class="pre"><a href="dom_event.asp">Previous Page</a></li>

<li class="next"><a href="dom_htmldocument.asp">Next Page</a></li>
</ul>
...
<p>HTMLDocument 接口的许多属性都是 HTMLCollection 对象，它提供了访问诸如表单、图像和链接等文档元素的便捷方式。<a href="../htmldom/coll_form_elements.asp" title="HTML DOM elements 集合">form.elements</a> 和 <a href="../htmldom/coll_select_options.asp" title="HTML DOM options 集合">select.options</a> 都是 HTMLCollection 对象。HTMLCollection 还提供了遍历 <a href="../htmldom/dom_obj_table.asp" title="HTML DOM Table 对象">Table</a> 的各行以及 <a href="../htmldom/dom_obj_tablerow.asp" title="HTML DOM TableRow 对象">TableRow</a> 的各个单元格的一种方便方法。</p>

<p>在上面已经提到了，HTMLCollection 对象是带有方法的 HTML 元素的集合，用它可以通过元素在文档中的位置或它们的 id 属性、name 属性获取元素。在 JavaScript 中，HTMLCollection 对象的行为和只读数组一样，可以使用 JavaScript 的方括号，通过编号或名称索引一个 HTMLCollection 对象，而不必调用 <a href="met_htmlcollection_item.asp" title="XML DOM item() 方法">item() 方法</a>和 <a href="met_htmlcollection_nameditem.asp" title="XML DOM namedItem() 方法">namedItem() 方法</a>。</p>

<p>HTMLCollection 对象是只读的，不能给它添加新元素，即使采用 JavaScript 数组语法也是如此。</p>

<p>HTMLCollection 对象和 <a href="dom_nodelist.asp" title="XML DOM NodeList 对象">NodeList 对象</a>很相似，但前者可能既能用名称索引也能用数字索引。</p>
</div>
...
<tr>
	<td><a href="met_htmlcollection_item.asp">item()</a></td>
	<td>返回集合中指定位置的元素（节点）。</td>
</tr>
<tr>
	<td><a href="met_htmlcollection_nameditem.asp">namedItem()</a></td>
...
<div>
<h2>相关页面</h2>
<p>XML DOM 参考手册：<a href="dom_htmldocument.asp" title="XML DOM HTMLDocument 对象">HTMLDocument 对象</a></p>
<p>XML DOM 参考手册：<a href="dom_nodelist.asp" title="XML DOM NodeList 对象">NodeList 对象</a></p>
