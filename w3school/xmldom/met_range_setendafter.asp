...
<h3>抛出</h3>
<p>如果 <i>refNode</i> 是 Document、DocumentFragment 或 Attr 节点，或者 <i>refNode</i> 的根包容节点不是 Document、DocumentFragment 或 Attr 节点，该方法将抛出代码为 INVALID_NODE_TYPE_ERR 的 <a href="dom_rangeexception.asp" title="XML DOM - RangeException 对象">RangeException 异常</a>。</p>
