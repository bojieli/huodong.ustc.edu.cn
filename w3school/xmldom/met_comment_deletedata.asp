...
<p>以下代码段使用 JavaScript 函数 <a href="dom_loadxmldoc.asp" title="XML DOM 加载函数">loadXMLDoc()</a> 把 XML 文件 <a href="../example/xdom/books_comment.xml">books_comment.xml</a> 载入 xmlDoc 中，然后从第一个注释节点中删除一些字符：</p>
...
<p>XML DOM 参考手册：<a href="met_characterdata_deletedata.asp">CharacterData.deleteData()</a></p>
</div>
