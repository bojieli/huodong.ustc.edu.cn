...
<li class="pre"><a href="dom_domimplementation.asp">Previous Page</a></li>

<li class="next"><a href="dom_element.asp">Next Page</a></li>
</ul>
...
<h3>说明</h3>
<p>DOMParser 对象解析 XML 文本并返回一个 <a href="dom_document.asp" title="XML DOM - Document 对象">XML Document 对象</a>。要使用 DOMParser，使用不带参数的构造函数来实例化它，然后调用其 parseFromString() 方法：</p>
<pre>var doc = (new DOMParser()).parseFromString(<i>text</i>)</pre>
<p>IE 不支持 DOMParser 对象。相反，它支持使用 <a href="met_document_loadxml.asp" title="XML DOM loadXML() 方法">Document.loadXML()</a> 的 XML 解析。</p>
<p>注意，XMLHttpRequest 对象也可以解析 XML 文档。参阅 XMLHttpRequest 的 <a href="dom_http.asp#responseXML" title="responseXML">responseXML</a> 属性。</p>
</div>
...
<h3>返回值</h3>
<p>保存 <i>text</i> 解析后表示的一个 <a href="dom_document.asp" title="XML DOM - Document 对象">Document 对象</a>。参阅 <a href="met_document_loadxml.asp" title="XML DOM loadXML() 方法">Document.loadXML()</a>，了解这个方法的一个特定于 IE 的替代。</p>
</div>
