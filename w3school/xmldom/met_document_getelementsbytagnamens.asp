...
<h3>返回值</h3>
<p>文档树中具有指定命名空间和本地名的 Element 节点的只读数组（从技术上讲，是 <a href="dom_nodelist.asp" title="XML DOM - NodeList 对象">NodeList 对象</a>）。</p>

<h3>说明</h3>
<p>该方法与 <a href="met_document_getelementsbytagname.asp" title="XML DOM getElementsByTagName() 方法">getElementsByTagName() 方法</a>相似，只是它根据命名空间和名称来检索元素。只有使用命名空间的 XML 文档才会使用它。</p>
</div>
