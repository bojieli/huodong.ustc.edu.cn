...
<h3>返回值</h3>
<p>如果在事件传播过程中调用了 <i>evt</i> 的 <a href="met_event_preventdefault.asp" title="XML DOM preventDefault() 方法">preventDefault() 方法</a>，则返回 false，否则返回 true。</p>
...
<h3>描述</h3>
<p>该方法将分派一个合成事件，它由 <a href="met_document_createevent.asp" title="XML DOM createEvent() 方法">Document.createEvent()</a> 创建，由 Event 接口或它的某个子接口定义的初始化方法初始化。</p>
