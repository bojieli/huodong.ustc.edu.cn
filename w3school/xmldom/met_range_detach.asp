...
<h3>抛出</h3>
<p>和所有 Range 方法一样，如果在已经被释放了的 Range 对象上调用 detach()，该方法将抛出代码为 INVALID_STATE_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
