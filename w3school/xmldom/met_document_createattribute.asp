...
<h3>抛出</h3>
<p>如果 name 参数中含有不合法的字符，该方法将抛出代码为 INVALID_CHARACTER_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>

<h3>参阅</h3>
<p><a href="met_element_setattribute.asp" title="XML DOM setAttribute() 方法">Element.setAttribute()</a> 、 <a href="met_element_setattributenode.asp" title="XML DOM setAttributeNode() 方法">Element.setAttributeNode()</a></p>
</div>
