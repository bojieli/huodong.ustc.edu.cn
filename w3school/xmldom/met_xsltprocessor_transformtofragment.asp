...
<p><a href="dom_xsltprocessor.asp" title="XML DOM XSLTProcessor 对象">XSLTProcessor 对象参考手册</a></p>
</div>

<div>
<h2>定义和用法</h2>

<p>transformToFragment() 方法把一个节点或文档转换为一个 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment</a>。</p>
...
<h3>返回值</h3>
<p>保存了转换结果的一个 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 对象</a>。</p>

<h3>说明</h3>
<p>这个方法在一个指定的节点上执行一次 XSLT 转换，结果作为一个 <a href="dom_documentfragment.asp" title="XML DOM - DocumentFragment 对象">DocumentFragment 对象</a>返回。转换使用 importStylesheet() 指定的 XSLT 样式表和 setParameter() 指定的参数值。返回的片段被插入到指定的 owner 文档中。</p>
</div>
