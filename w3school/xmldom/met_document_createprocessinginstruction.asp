...
<h3>抛出</h3>
<p>如果 <i>target</i> 中含有不合法的字符，则抛出代码为 INVALID_CHARACTER_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
<p>如果是一个 HTML 文档，不支持处理指令，将抛出代码为 NOT_SUPPORTED_ERR 的 <a href="dom_domexception.asp" title="XML DOM - DOMException 对象">DOMException 异常</a>。</p>
</div>
