...
<p>一个 <a href="dom_xpathexpression.asp" title="XML DOM - XPathExpression 对象">XPathExpression 对象</a>。</p>
...
<p>IE 不支持这个 API。参阅 <a href="met_node_selectnodes.asp" title="XML DOM selectNodes() 方法">Node.selectNodes()</a> 了解一种特定于 IE 的替代方法。</p>
</div>
