...
<li class="pre"><a href="sql_constraints.asp">Previous Page</a></li>

<li class="next"><a href="sql_unique.asp">Next Page</a></li>
</ul>
...
<p>NOT NULL 约束强制字段始终包含值。这意味着，如果不向字段添加值，就无法插入新纪录或者更新记录。</p>
