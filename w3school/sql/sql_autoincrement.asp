...
<li class="pre"><a href="sql_alter.asp">Previous Page</a></li>

<li class="next"><a href="sql_view.asp">Next Page</a></li>
</ul>
...
<div>
<p><strong>Auto-increment 会在新纪录插入表中时生成一个唯一的数字。</strong></p>
</div>
...
<p>我们通常希望在每次插入新纪录时，自动地创建主键字段的值。</p>
...
<p>默认地，AUTO_INCREMENT 的开始值是 1，每条新纪录递增 1。</p>
...
<p>上面的 SQL 语句会在 &quot;Persons&quot; 表中插入一条新纪录。&quot;P_Id&quot; 会被赋予一个唯一的值。&quot;FirstName&quot; 会被设置为 &quot;Bill&quot;，&quot;LastName&quot; 列会被设置为 &quot;Gates&quot;。</p>
</div>
...
<p>默认地，IDENTITY 的开始值是 1，每条新纪录递增 1。</p>
...
<p>默认地，AUTOINCREMENT 的开始值是 1，每条新纪录递增 1。</p>
...
<p>要在 &quot;Persons&quot; 表中插入新纪录，我们必须使用 nextval 函数（该函数从 seq_person 序列中取回下一个值）：</p>
...
<p>上面的 SQL 语句会在 &quot;Persons&quot; 表中插入一条新纪录。&quot;P_Id&quot; 的赋值是来自 seq_person 序列的下一个数字。&quot;FirstName&quot; 会被设置为 &quot;Bill&quot;，&quot;LastName&quot; 列会被设置为 &quot;Gates&quot;。</p>
</div>
