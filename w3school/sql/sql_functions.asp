...
<li class="pre"><a href="sql_server.asp">Previous Page</a></li>

<li class="next"><a href="sql_func_avg.asp">Next Page</a></li>
</ul>
...
<tr>
<td><a href="sql_func_avg.asp" title="SQL AVG 函数">AVG(column)</a></td>
<td>返回某列的平均值</td>
</tr>

<tr>
<td><a href="sql_func_count.asp" title="SQL COUNT 函数">COUNT(column)</a></td>
<td>返回某列的行数（不包括 NULL 值）</td>
</tr>

<tr>
<td><a href="sql_func_count_ast.asp" title="SQL COUNT(*) 函数">COUNT(*)</a></td>
<td>返回被选行数</td>
</tr>
...
<tr>
<td><a href="sql_func_max.asp" title="SQL MAX 函数">MAX(column)</a></td>
<td>返回某列的最高值</td>
</tr>

<tr>
<td><a href="sql_func_min.asp" title="SQL MIN 函数">MIN(column)</a></td>
<td>返回某列的最低值</td>
</tr>
...
<tr>
<td><a href="sql_func_sum.asp" title="SQL SUM 函数">SUM(column)</a></td>
<td>返回某列的总和</td>
</tr>
...
<tr>
<td><a href="sql_func_count_distinct.asp" title="SQL COUNT DISTINCT 函数">COUNT(DISTINCT column)</a></td>
<td>返回相异结果的数目</td>
</tr>

<tr>
<td><a href="sql_func_first.asp" title="SQL FIRST 函数">FIRST(column)</a></td>
<td>返回在指定的域中第一个记录的值（SQLServer2000 不支持）</td>
</tr>

<tr>
<td><a href="sql_func_last.asp" title="SQL LAST 函数">LAST(column)</a></td>
