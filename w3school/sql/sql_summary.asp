...
<li class="pre"><a href="sql_quickref.asp">Previous Page</a></li>

<li class="next"><a href="sql_quiz.asp">Next Page</a></li>
</ul>
...
<p>我们已经学习了如何使用 SQL 在数据库中执行查询、获取数据、插入新的纪录、删除记录以及更新记录。</p>
