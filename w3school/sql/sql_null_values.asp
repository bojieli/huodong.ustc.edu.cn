...
<li class="pre"><a href="sql_dates.asp">Previous Page</a></li>

<li class="next"><a href="sql_isnull.asp">Next Page</a></li>
</ul>
...
<p>如果表中的某个列是可选的，那么我们可以在不向该列添加值的情况下插入新纪录或更新已有的记录。这意味着该字段将以 NULL 值保存。</p>
