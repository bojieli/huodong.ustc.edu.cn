...
<li class="pre"><a href="sql_notnull.asp">Previous Page</a></li>

<li class="next"><a href="sql_primarykey.asp">Next Page</a></li>
</ul>
...
<p>当表已被创建时，如需在 &quot;P_Id&quot; 列创建 UNIQUE 约束，请使用下列 SQL：</p>

<h3>MySQL / SQL Server / Oracle / MS Access:</h3>

<pre>
ALTER TABLE Persons
<code>ADD UNIQUE (P_Id)</code>
</pre>
...
<pre>
ALTER TABLE Persons
<code>ADD CONSTRAINT uc_PersonID UNIQUE (P_Id,LastName)</code>
</pre>
</div>
