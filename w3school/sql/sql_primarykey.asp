...
<li class="pre"><a href="sql_unique.asp">Previous Page</a></li>

<li class="next"><a href="sql_foreignkey.asp">Next Page</a></li>
</ul>
...
Address varchar(255),
City varchar(255),
<code>CONSTRAINT uc_PersonID PRIMARY KEY (Id_P,LastName)</code>
)
</pre>
</div>
